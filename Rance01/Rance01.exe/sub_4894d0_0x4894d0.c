...
if (p)
    ...
    float var_40_1 = fconvert.s(fconvert.t(var_40) / fconvert.t(*(arg6 i+ 0xc)))
    float var_68_1 = fconvert.s(fconvert.t(arg9) / fconvert.t(ebx[3]))
    float var_70_1 = fconvert.s(fconvert.t(var_3c) / fconvert.t(edi[3]))
    float var_88_1 = fconvert.s(fconvert.t(var_30) / fconvert.t(*(arg6 i+ 0xc)))
    float var_80_1 = fconvert.s(fconvert.t(var_34) / fconvert.t(ebx[3]))
    float var_a4_1 = fconvert.s(fconvert.t(var_38) / fconvert.t(edi[3]))
    *(arg6 i+ 0xc)
    ...
    long double x87_r5_5 = fconvert.t(var_44)
    ...
    long double x87_r6_21 = fconvert.t(var_8)
    ...
    arg11 = fconvert.s(x87_r7_54 * fconvert.t(var_54_1) + fconvert.t(fconvert.s(
        fconvert.t(fconvert.s(x87_r5 * x87_r2 - x87_r4_2 * x87_r7_14)) * x87_r3_7)))
    arg10 = fconvert.s(x87_r7_54 * fconvert.t(var_1c_1) + fconvert.t(fconvert.s(
    ...
    if (i_2 s> 0)
        ...
        do
            arg6 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_58_1)))
                + fconvert.t(arg11))
            arg7 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_20_1)))
                + fconvert.t(arg10))
            arg9 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_2c_1)))
                + fconvert.t(arg8))
            ...
            if (j_2 s> 0)
                ...
                do
                    ...
                    int32_t edi_3 = sub_70c710(fconvert.t(fconvert.s((
                        x87_r6_42 * fconvert.t(var_68_1) + x87_r4_20 * fconvert.t(var_40_1)
                    ...
                    arg6 = fconvert.s(x87_r4_20 + fconvert.t(var_58_1))
                    int32_t eax_26 = eax_24 * var_4c_1:4.d + var_64:4.d
                    arg7 = fconvert.s(x87_r6_42 + fconvert.t(var_20_1))
                    ecx_8.b = *esi_3
                    void* eax_27 = eax_26 + (edi_3 << 2)
                    arg9 = fconvert.s(x87_r3_30 + fconvert.t(var_2c_1))
                    uint32_t edi_4 = zx.d(*(eax_27 + 3))
                    char ebx_6 =
                        (((zx.d(*(eax_26 + (edi_3 << 2))) - zx.d(ecx_8.b)) * edi_4) s>> 8).b
                        + ecx_8.b
                    ecx_8.b = *(esi_3 + 1)
                    *esi_3 = ebx_6
                    char edx_14 =
                        (((zx.d(*(eax_27 + 1)) - zx.d(ecx_8.b)) * edi_4) s>> 8).b + ecx_8.b
                    ecx_8.b = *(esi_3 + 2)
                    *(esi_3 + 1) = edx_14
                    *(esi_3 + 2) =
                        (((zx.d(*(eax_27 + 2)) - zx.d(ecx_8.b)) * edi_4) s>> 8).b + ecx_8.b
                    esi_3 += 4
                    j = j_1
                    j_1 -= 1
                while (j != 1)
            ...
            i = i_1
            i_1 -= 1
            arg11 = fconvert.s(fconvert.t(arg11) + fconvert.t(var_54_1))
            arg10 = fconvert.s(fconvert.t(arg10) + fconvert.t(var_1c_1))
            arg8 = fconvert.s(fconvert.t(arg8) + fconvert.t(var_28_1))
        while (i != 1)

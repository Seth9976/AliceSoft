...
float ebp = arg8
int32_t edi = arg1
float var_10 = fconvert.s(fconvert.t(arg4) * fconvert.t(0.5))
arg4 = 0f
...
do
    ...
    if (eax_2 != 0)
        ...
        if (eax_2 != 0)
            int32_t eax_3 = sub_70c710(fconvert.t(arg8) + fconvert.t(arg3))
            ...
            sub_5e3db0(eax_2, sub_70c710(x87_r7_10 + x87_r5_1 + x87_r4_2), eax_3, eax_5, eax_3, 
                arg6, arg7, ebp, 0xff)

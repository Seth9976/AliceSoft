...
float var_4 = fconvert.s(fconvert.t(arg2[1]))
float var_10 = fconvert.s(fconvert.t(*eax))
float* eax_1 = arg7
float var_8 = fconvert.s(fconvert.t(eax[1]))
float var_48 = fconvert.s(fconvert.t(*eax_1))
float* result = arg9
float var_3c = fconvert.s(fconvert.t(eax_1[1]))
...
long double x87_r5 = fconvert.t(var_4)
...
if (p)
    ...
    float var_54_1 = fconvert.s(fconvert.t(fconvert.s(x87_r7_14 - x87_r5)) * x87_r3_7)
    float var_50_1 = fconvert.s(fconvert.t(fconvert.s(x87_r4_2 - x87_r2)) * x87_r3_7)
    float var_20_1 =
    ...
    long double x87_r5_4 = fconvert.t(var_14)
    ...
    long double x87_r6_17 = fconvert.t(var_c)
    ...
    long double x87_r5_7 = fconvert.t(var_4)
    ...
    long double x87_r7_37 = fconvert.t(var_20_1)
    long double x87_r5_10 = fconvert.t(var_54_1)
    int32_t i_2 = sub_70c710(fconvert.t(fconvert.s(x87_r7_35))) - esi_2
    long double x87_r4_22 = fconvert.t(var_2c_1)
    double var_38_1
    var_38_1:4.d = fconvert.s(x87_r7_37 * fconvert.t(var_30) + x87_r5_10 * fconvert.t(var_3c)
        + x87_r4_22 * fconvert.t(var_40))
    void* esi_3 = (*(*arg4 + 8))(arg10, esi_2)
    float ecx_7 = edi_4
    result = (*(*arg4 + 0x1c))() - (ecx_7 << 2)
    long double x87_r7_42 = fconvert.t(fconvert.s(float.t(esi_2)))
    var_60:4.d = result
    arg8 = fconvert.s(x87_r7_42 * fconvert.t(var_50_1) + fconvert.t(fconvert.s(
        fconvert.t(fconvert.s(x87_r5 * x87_r2 - x87_r4_2 * x87_r7_14)) * x87_r3_7)))
    arg7 = fconvert.s(x87_r7_42 * fconvert.t(var_1c_1) + fconvert.t(fconvert.s(
    ...
    if (i_2 s> 0)
        ...
        do
            ...
            long double x87_r5_17 = fconvert.t(fconvert.s(
                fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_20_1))) + x87_r5_13))
            long double x87_r3_30 = fconvert.t(fconvert.s(
                fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_54_1))) + x87_r6_38))
            long double x87_r2_33 = fconvert.t(fconvert.s(
                fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_2c_1))) + fconvert.t(arg6)))
            arg10 = fconvert.s(x87_r5_17 * fconvert.t(arg9) + x87_r3_30 * fconvert.t(var_48)
                + x87_r2_33 * fconvert.t(var_44))
            arg8 = fconvert.s(x87_r5_17 * fconvert.t(var_30) + x87_r3_30 * fconvert.t(var_3c)
                + x87_r2_33 * fconvert.t(var_40))
            ...
            if (ecx_7 s> 0)
                ...
                do
                    ...
                    int32_t edi_7 = sub_70c710(x87_r3_32 * x87_r4_32) s>> 8
                    int32_t eax_25
                    int32_t ecx_8
                    eax_25, ecx_8 = sub_70c710(x87_r2_38 * x87_r4_32)
                    ...
                    if (eax_26 s< 0)
                        eax_26 = 0
                    else if (eax_26 s> var_90_1)
                        eax_26 = var_90_1
                    
                    arg10 = fconvert.s(x87_r3_32 + fconvert.t(fconvert.s(
                        x87_r7_37 * fconvert.t(arg9) + x87_r5_10 * fconvert.t(var_48)
                        + x87_r4_22 * fconvert.t(var_44))))
                    int32_t eax_28 = eax_26 * var_80:4.d + var_70:4.d
                    ecx_8.b = *esi_3
                    arg8 = fconvert.s(x87_r2_38 + fconvert.t(var_38_1:4.d))
                    void* edi_8 = eax_28 + (edi_7 << 2)
                    int32_t eax_31 = (zx.d(*(edi_8 + 3)) * arg11) s>> 8
                    char ebx_4 =
                        (((zx.d(*(eax_28 + (edi_7 << 2))) - zx.d(ecx_8.b)) * eax_31) s>> 8).b
                        + ecx_8.b
                    ecx_8.b = *(esi_3 + 1)
                    *esi_3 = ebx_4
                    char edx_13 =
                        (((zx.d(*(edi_8 + 1)) - zx.d(ecx_8.b)) * eax_31) s>> 8).b + ecx_8.b
                    ecx_8.b = *(esi_3 + 2)
                    *(esi_3 + 1) = edx_13
                    *(esi_3 + 2) =
                        (((zx.d(*(edi_8 + 2)) - zx.d(ecx_8.b)) * eax_31) s>> 8).b + ecx_8.b
                    esi_3 += 4
                    j = arg7
                    arg7 -= 1
                while (j != 1)
            ...
            i = i_1
            i_1 -= 1
            arg8 = fconvert.s(x87_r6_38 + fconvert.t(var_50_1))

...
struct _EXCEPTION_REGISTRATION_RECORD** Next = &ExceptionList
...
if (arg2 s> 0)
    ...
    if (eax_19 != 0)
        if ((*(**(*(eax_19 + 0xb4) + 8) + 8))(eax_2) != 8)
            ...
            *(*(eax_19 + 0xb4) + 8) = eax_24
            *(eax_19 + 0x10) = 1
        
        void* eax_25 = *(*(eax_19 + 0xb4) + 8)
    ...
    int32_t (__stdcall* var_10_2)(int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4) =
        sub_41cbc0
    sub_41c040(eax_5[2]->vFunc_1, arg1, arg2, 2)
    Next = sub_5f7370(*data_797da0, eax_5[2]->vFunc_1)
    
    if (Next != 0)
        if (Next[0x2d][1].Next->Next[1].Next(eax_2) != 8)
            Next[0x2d][1].Next->Next->Handler()
            ...
            if (eax_31 == 0)
                ...
                eax_32 = sub_5e0230(Next[0xf], Next[0xe], Next[0xd], Next[3] + 0x1b4, eax_31)
            
            Next[0x2d][1].Next = eax_32
            Next[4].b = 1
        
        Next = Next[0x2d][1].Next
        
        if (Next != 0)
            Next = sub_5e4050(Next)

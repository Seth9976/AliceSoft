...
double xmm1[0x2] = data_761d30
double xmm6[0x2] = data_761d10
double xmm2[0x2] = data_761d40
double xmm3[0x2] = data_761d50
...
uint64_t xmm7_4[0x2] = _mm_slli_epi64(_mm_add_epi64(xmm1_2 & data_761cf0, data_761d00), 0x2e)
...
int64_t xmm6_5 = _mm_or_pd(data_761ce0 & not.o(xmm2_4), _mm_slli_epi64(zx.o(eax_5 + 0x3ff), 0x34))
...
label_70f5b7:
    var_c = xmm0_9
    sub_6b7e6f(&arg3, &arg3, &var_c, edx_7)
    xmm0_9 = var_c
else if (ecx_5 == 0)
    edx_7 = 0xf
    goto label_70f5b7

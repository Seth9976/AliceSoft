    ...
    do
        if (arg7 s> 0)
            ...
            do
                ...
                int32_t ecx_26
                ecx_26.b = *(((zx.d(edx_16:2.b) * zx.d(arg13:3.b)) s>> 8) + zx.d(arg12:3.b) + edi)
                arg8:2.b = ecx_26.b
                uint32_t ecx_27 = zx.d(*(var_8 + 3))
                void* edx_18
                edx_18.b = *esi
                uint32_t eax_28 = zx.d(edx_18.b)
                int32_t ebx_4 = ((zx.d(ebx.b) * eax_28) s>> 8) - eax_28
                eax_28.b = *(esi + 1)
                *esi = ((ebx_4 * ecx_27) s>> 8).b + edx_18.b
                uint32_t edx_19 = zx.d(eax_28.b)
                char ebx_12 =
                    (((((zx.d(arg8:1.b) * edx_19) s>> 8) - edx_19) * ecx_27) s>> 8).b + eax_28.b
                eax_28.b = *(esi + 2)
                *(esi + 1) = ebx_12
                uint32_t edx_20 = zx.d(eax_28.b)
                ebx.b = (((((zx.d(arg8:2.b) * edx_20) s>> 8) - edx_20) * ecx_27) s>> 8).b + eax_28.b
                var_4 = &var_4[1]
                var_8 += 4
                *(esi + 2) = ebx.b
                esi += 4

...
float var_d0 = fconvert.s(fconvert.t(var_5c) - x87_r2_17)
...
if ((eax_2:1.b & 0x41) != 0)
    ...
    if (p_1)
        ...
        float var_70 = fconvert.s(fconvert.t(var_d0) * x87_r4_10)
        float var_28_1 = fconvert.s(x87_r1_17 * x87_r4_10)
        float var_24_1 = fconvert.s(x87_r2_24 * x87_r4_10)
        var_9c:4.d = (*(*arg2 + 8))(0, 0)
        double var_7c_1
        var_7c_1:4.d = (*(*arg2 + 0x1c))()
        int32_t eax_9 = (*(*arg2 + 0x10))() - 1
        double var_84_1
        var_84_1:4.d = (*(*arg2 + 0x14))() - 1
        ...
        float var_ac = fconvert.s(fconvert.t(var_68) / fconvert.t(edi[3]))
        float var_bc = fconvert.s(fconvert.t(var_60) / fconvert.t(*(arg6 i+ 0xc)))
        float var_b4 = fconvert.s(fconvert.t(var_48) / fconvert.t(ebx[3]))
        float var_c4 = fconvert.s(fconvert.t(var_64) / fconvert.t(edi[3]))
        *(arg6 i+ 0xc)
        long double x87_r6_7 = float.t(1)
        float var_c8 = fconvert.s(x87_r6_7 / fconvert.t(ebx[3]))
        float var_c0 = fconvert.s(x87_r6_7 / fconvert.t(edi[3]))
                    ...
                    do
                        ...
                        label_48f9c4:
                            ...
                            eax_26, ecx_8 = sub_70c710(fconvert.t(fconvert.s(x87_r2_49 * (
                                x87_r5_23 * fconvert.t(var_b4) + x87_r3_38 * fconvert.t(var_bc)
                                + x87_r3_37 * fconvert.t(var_c4)))))
                            
                            if (edi_3 s< 0)
                                edi_3 = 0
                            else if (edi_3 s> eax_9)
                                edi_3 = eax_9
                            ...
                            x87_r4_42 = float.t(0)
                            char ebx_6 =
                                (((zx.d(*(eax_28 + (edi_3 << 2))) - zx.d(ecx_8.b)) * edi_4) s>> 8).b
                                + ecx_8.b
                            ecx_8.b = esi_3[1]
                            *esi_3 = ebx_6
                            char edx_14 =
                                (((zx.d(*(eax_29 + 1)) - zx.d(ecx_8.b)) * edi_4) s>> 8).b + ecx_8.b
                            ecx_8.b = esi_3[2]
                            esi_3[1] = edx_14
                            eax_24.b =
                                (((zx.d(*(eax_29 + 2)) - zx.d(ecx_8.b)) * edi_4) s>> 8).b + ecx_8.b
                            esi_3[2] = eax_24.b

...
void* esi = *(arg1 + 0x4834)
int32_t ebp = *(arg1 + 0x3c)
int32_t ebx = *(arg1 + 0x37f0)
int32_t var_b4 = data_79b948
int32_t var_b0 = data_79b94c
int32_t var_ac = data_79b950
int32_t var_a8 = data_79b954
void var_a4
int32_t eax_6 = sub_6e0940(arg1 + 4, 0x10, 0x10, arg2, arg3, *(arg1 + 0x30), ebp, *(arg1 + 0x20), 
...
if (zx.d(sub_6e0c40(&var_a4, &var_b4)) != 0)
    return (*(ebx + 0xb0))(esi, esi + 0x200, esi + 0x280, edi_1, ebp)
...
if (zx.d(sub_6e0c70(&var_84, &data_79b8e0)) != 0)
    sub_6e5d50(esi, esi + 0x200, esi + 0x280, edi_1, &var_84, ebp)
...
if (zx.d(sub_6e0c70(&var_84, &data_79b8e0)) != 0)
    sub_6e5d50(esi + 0x80, esi + 0x208, esi + 0x288, edi_1 + 0x18, &var_84, ebp)
...
if (zx.d(sub_6e0c70(&var_84, &data_79b8e0)) != 0)
    sub_6e5d50(esi + 0x100, esi + 0x240, esi + 0x2c0, edi_1 + (ebp << 3), &var_84, ebp)
...
int32_t eax_25 = zx.d(sub_6e0c70(&var_84, &data_79b8e0))

if (eax_25 == 0)
    return eax_25

return sub_6e5d50(esi + 0x180, esi + 0x248, esi + 0x2c8, edi_1 + (ebp << 3) + 0x18, &var_84, ebp)

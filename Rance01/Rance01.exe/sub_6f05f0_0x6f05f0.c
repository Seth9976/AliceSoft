...
int32_t var_74 = data_79ba58
int32_t var_70 = data_79ba5c
int32_t var_6c = data_79ba60
int32_t var_68 = data_79ba64
void var_64
...
if (zx.d(sub_6e0c40(&var_64, &var_74)) != 0)
    return (*(ebx + 0xdc))(ebp, ebp + 0x100, ebp + 0x180, edi_1, esi)
...
if (zx.d(sub_6e0c70(&var_44, &data_79b8e0)) != 0)
    sub_6f03c0(ebp, ebp + 0x100, ebp + 0x180, edi_1, &var_44, esi)
...
return sub_6f03c0(ebp + 0x80, ebp + 0x108, ebp + 0x188, edi_1 + 0x10, &var_44, esi)

...
if (p)
    ...
    float var_3c_1 = fconvert.s(fconvert.t(var_3c) / fconvert.t(*(arg6 i+ 0xc)))
    float var_6c_1 = fconvert.s(fconvert.t(arg9) / fconvert.t(ebx[3]))
            ...
            if (j_2 s> 0)
                ...
                do
                    ...
                    int32_t edi_3 = sub_70c710(fconvert.t(fconvert.s((
                        x87_r6_42 * fconvert.t(var_6c_1) + x87_r4_20 * fconvert.t(var_3c_1)
                        + x87_r3_30 * fconvert.t(var_74_1)) * x87_r2_38)))
                    int32_t eax_24
                    int32_t ecx_8
                    eax_24, ecx_8 = sub_70c710(fconvert.t(fconvert.s(x87_r2_38 * (
                        x87_r6_42 * fconvert.t(var_84_1) + x87_r4_20 * fconvert.t(var_8c_1)
                        + x87_r3_30 * fconvert.t(var_a8_1)))))
                    ...
                    int32_t eax_26 = eax_24 * var_50_1:4.d + var_68:4.d
                    arg9 = fconvert.s(x87_r6_42 + fconvert.t(var_20_1))
                    ecx_8.b = *esi_3
                    void* edi_4 = eax_26 + (edi_3 << 2)
                    var_10_1 = fconvert.s(x87_r3_30 + fconvert.t(var_2c_1))
                    int32_t eax_29 = (zx.d(*(edi_4 + 3)) * arg11) s>> 8
                    char ebx_6 =
                        (((zx.d(*(eax_26 + (edi_3 << 2))) - zx.d(ecx_8.b)) * eax_29) s>> 8).b
                        + ecx_8.b
                    ecx_8.b = *(esi_3 + 1)
                    *esi_3 = ebx_6
                    char edx_14 =
                        (((zx.d(*(edi_4 + 1)) - zx.d(ecx_8.b)) * eax_29) s>> 8).b + ecx_8.b
                    ecx_8.b = *(esi_3 + 2)
                    *(esi_3 + 1) = edx_14
                    *(esi_3 + 2) =
                        (((zx.d(*(edi_4 + 2)) - zx.d(ecx_8.b)) * eax_29) s>> 8).b + ecx_8.b
                    esi_3 += 4
                    j = j_1
                    j_1 -= 1
                while (j != 1)

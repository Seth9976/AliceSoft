    ...
    do
        ...
        if (ecx_27 != 0)
            ...
            if (j_6 s> 0)
                ...
                do
                    ...
                    char edx_25 =
                        (((((zx.d(xmm3_9.b) * eax_26) s>> 8) - eax_26) * ecx_34) s>> 8).b + *esi_1
                    esi_1 += 4
                    *(esi_1 - 4) = edx_25
                    uint32_t eax_28 = zx.d(*(esi_1 - 2))
                    edi_1 += 4
                    *(esi_1 - 3) +=
                        (((((zx.d(xmm3_9:1.b) * eax_27) s>> 8) - eax_27) * ecx_34) s>> 8).b
                    ebx_1 += 4
                    j = j_3
                    j_3 -= 1
                    *(esi_1 - 2) +=
                        (((((zx.d(xmm3_9:2.b) * eax_28) s>> 8) - eax_28) * ecx_34) s>> 8).b
                while (j != 1)
                result = result_1
        ...
        if (result s> 0)
            ...
            do
                ...
                int32_t xmm1_3[0x4] = xmm2_2 & _mm_srli_epi32(
                    _mm_adds_epu8(
                        __pmullw_xmmdq_memdq(xmm2_2 & _mm_srli_epi32(xmm3_10, 8), xmm5_3), xmm7)
                        & xmm3_1, 
                    8)
                uint32_t xmm4_8[0x4] = _mm_srli_epi32(*ebx_1, 0x18)
        ...
        if (j_5 s> 0)
            ...
            do
                ...
                char edx_44 =
                    (((((zx.d(xmm3_20.b) * eax_32) s>> 8) - eax_32) * ecx_35) s>> 8).b + *esi_1
                esi_1 += 4
                *(esi_1 - 4) = edx_44
                result = zx.d(*(esi_1 - 2))
                edi_1 += 4
                *(esi_1 - 3) += (((((zx.d(xmm3_20:1.b) * eax_33) s>> 8) - eax_33) * ecx_35) s>> 8).b
                ebx_1 += 4
                j_2 = j_4
                j_4 -= 1
                *(esi_1 - 2) += (((((zx.d(xmm3_20:2.b) * result) s>> 8) - result) * ecx_35) s>> 8).b
            while (j_2 != 1)

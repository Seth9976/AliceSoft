...
if (p)
    ...
    float var_1f0_3 = fconvert.s(fconvert.t(var_1a0_1))
    var_140.o = zx.o(0)
        ...
        do
            ...
            if (j_2 s> 0)
                ...
                do
                    ...
                    float xmm5_12 = xmm1_11 * var_1e0_2
                    xmm1_11 = xmm1_11 + var_1f4_3
                    float xmm6_10 = xmm0_22 * var_1c4_2
                    xmm0_22 = xmm0_22 + var_200_16
                    float xmm5_14 = xmm2_2 * var_1e4_2
                    xmm2_2 = xmm2_2 + var_1f0_3
                    *esi_3 = *(edi_5 + (int.d(__minss_xmmss_memss(
                        _mm_max_ss((xmm6_10 + xmm5_12 + xmm5_14) * xmm5_6, 0), 

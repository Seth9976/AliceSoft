...
int32_t var_54 = data_79ba08
int32_t var_50 = data_79ba0c
int32_t var_4c = data_79ba10
int32_t var_48 = data_79ba14
void var_44
...
if (zx.d(sub_6e0c40(&var_44, &var_54)) != 0)
    return (*(ebx + 0xd8))(ebp, ebp + 0x80, ebp + 0x100, edi_1, esi)
...
return sub_6eed30(ebp, ebp + 0x80, ebp + 0x100, edi_1, &var_24, esi)

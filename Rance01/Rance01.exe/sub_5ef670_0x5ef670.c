...
for (int32_t* i = &arg1[0x1b]; i != arg2; i = &i[0x1b])
    void* i_1 = i
    int32_t var_7c
    int32_t edx_1 = sub_5ee970(i, &var_7c)
    int32_t var_4 = 0
    int32_t j_1
    int32_t j = j_1
    void* eax_8
    ...
    if (j s>= arg1[2])
        ...
        *(i_1 + 0x48) = var_34
        ...
        sub_5efbf0(i, edx_1, &i[0x1b], arg1)
        int32_t edx_2 = var_7c
        arg1[1] = var_78
        *arg1 = edx_2
        arg1[2] = j_1
        arg1[3] = var_70

...
float var_254 = fconvert.s(fconvert.t(*arg9))
float var_290 = fconvert.s(fconvert.t(arg9[1]))
float var_298 = fconvert.s(fconvert.t(*arg11))
float var_288 = fconvert.s(fconvert.t(arg11[1]))
float var_260 = fconvert.s(fconvert.t(*arg12))
float var_29c = fconvert.s(fconvert.t(arg12[1]))
float var_25c = fconvert.s(fconvert.t(*arg8))
float var_28c = fconvert.s(fconvert.t(arg8[1]))
float var_258 = fconvert.s(fconvert.t(*arg10))
float var_294 = fconvert.s(fconvert.t(arg10[1]))
...
if ((result:1.b & 0x41) != 0)
    ...
    if (p_1)
        ...
        var_1b8.d = (*(*arg13 + 8))(0, 0)
        double var_1f8_1
        var_1f8_1.d = (*(*arg13 + 0x1c))()
        int32_t eax_8 = (*(*arg13 + 0x10))() - 1
        double var_280_1
        var_280_1.d = (*(*arg13 + 0x14))() - 1
        float var_25c_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_25c) / fconvert.t(arg7[3]))))
        float var_258_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_258) / fconvert.t(arg9[3]))))
        float var_264_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_264) / fconvert.t(arg11[3]))))
        float var_28c_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_28c) / fconvert.t(arg7[3]))))
        float var_294_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_294) / fconvert.t(arg9[3]))))
        float var_2a0_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_2a0) / fconvert.t(arg11[3]))))
        arg7[3]
        long double x87_r6_7 = float.t(1)
        float var_2a0_6 = fconvert.s(fconvert.t(fconvert.s(x87_r6_7 / fconvert.t(arg9[3]))))
        float var_2a0_8 = fconvert.s(fconvert.t(fconvert.s(x87_r6_7 / fconvert.t(arg11[3]))))
        ...
        char* esi_3 = (*(*arg5 + 8))(var_260_1, esi_2)
        int32_t j_2 = j_3
                ...
                if (j_2 s> 0)
                    ...
                    do
                        if (not(xmm0_24 f< 0) && not(xmm1_12 f< 0) && not(xmm3_3 f< 0)
                            ...
                            char* ecx_9 = int.d(__minss_xmmss_memss(
                                __maxss_xmmss_memss(
                            ...
                            var_208.d = 0
                            char ebx_7 =
                                (((zx.d(*ecx_9) - zx.d(edx_10.b)) * arg4) s>> 8).b + edx_10.b
                            edx_10.b = esi_3[1]
                            *esi_3 = ebx_7
                            xmm5_3 = var_2a0_16
                            xmm6 = var_294_3

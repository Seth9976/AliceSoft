...
int32_t var_74 = 0
char var_84 = 0
sub_401270(&var_84, 0x15, "DPPartsDPSpriteWindow")
int32_t var_4 = 0

if (*(arg1 + 0x10c) == 0)
    struct dpparts::CWindow::dpparts::CDPSpriteWindow::VTable** eax_6 = operator new(0xa8)
    var_4.b = 1
    struct dpparts::CWindow::dpparts::CDPSpriteWindow::VTable** eax_13
    ...
    if (eax_6 == 0)
        ...
        eax_13 = sub_64cad0(eax_8, eax_7, eax_6, *(arg1 + 0x18), var_94, eax_10, eax_9)
...
if (*(*(arg1 + 0x10c) + 0x34) == 0)
    ...
    sub_65e420(lpwndpl_1.rcNormalPosition.right - lpwndpl_1.rcNormalPosition.left, esi_4, edi_1, 
        *(arg1 + 0x10c), 0x56000000, 0, *(arg1 + 0x5c), arg2, nullptr, *(arg1 + 0x18))

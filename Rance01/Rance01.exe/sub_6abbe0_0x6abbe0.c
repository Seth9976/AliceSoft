...
void* i_2 = i
sub_6ad030(arg2, arg3 - 0x28, arg4)
int32_t* i_3 = i + 0x28
int32_t* i_7 = i_3

for (; arg2 u< i; i -= 0x28)
    int32_t eax_9 = *(i + 0x24)
    int32_t edx_4 = *(i - 4)
...
if (i_3 u< arg3)
    int32_t edx_5 = *(i + 0x24)
    
    do
        int32_t eax_10 = i_3[9]
...
while (true)
    for (; i_1 u< arg3; i_1 = &i_1[0xa])
        int32_t eax_11 = i_1[9]
        int32_t edx_6 = *(i + 0x24)
    ...
    if (i_5 u> edi_2)
        do
            int32_t eax_12 = *(i_5 - 4)
            int32_t edx_7 = *(i + 0x24)

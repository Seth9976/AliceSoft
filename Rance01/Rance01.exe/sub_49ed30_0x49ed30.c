...
float var_248 = fconvert.s(fconvert.t(*arg8))
float var_264 = fconvert.s(fconvert.t(arg8[1]))
...
float var_274 = fconvert.s(fconvert.t(arg10[1]))
float var_1e8 = fconvert.s(fconvert.t(*arg7))
float var_25c = fconvert.s(fconvert.t(arg7[1]))
float var_1e4 = fconvert.s(fconvert.t(*arg9))
float var_244 = fconvert.s(fconvert.t(arg9[1]))
                ...
                if (j_2 s> 0)
                    ...
                    do
                        if (not(xmm1_11 f< 0) && not(xmm2_3 f< 0) && not(xmm4_3 f< 0)
                            ...
                            int32_t edx_8
                            edx_8.b = *esi_3
                            char* edi_5 = (int.d(__minss_xmmss_memss(_mm_max_ss(xmm3_7, 0), xmm0_19)
                            ...
                            *esi_3 = (((zx.d(*edi_5) - zx.d(edx_8.b)) * ecx_11) s>> 8).b + edx_8.b
                            xmm6_10 = var_27c_10
                            char edx_12 =
                            ...
                            esi_3[1] = edx_12
                            edx_8.b =
                                (((zx.d(edi_5[2]) - zx.d(eax_28.b)) * ecx_11) s>> 8).b + eax_28.b
                            esi_3[2] = edx_8.b

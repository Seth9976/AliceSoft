    ...
    if (edx.b != 0)
        while (true)
            ...
            if (edx.b - 0x20 u> 0x58)
                ...
                eax_12 = sx.d(*(sx.d(edx.b) + &data_72b148)) & 0xf
            
            uint32_t eax_14 = sx.d(*(ecx_8 + (eax_12 << 3) + 0x72b168)) s>> 4
                ...
                case 6
                    if (edx.b == 0x49)
                        ...
                        label_6b9dd9:
                            ...
                            uint32_t eax_22
                            int32_t edx_1
                            eax_22, edx_1 = sub_6c0d19(edx.b, &var_260)
                            bool cond:0_1 = eax_22 == 0
                            eax_22.b = var_215_1
                            
                            if (not(cond:0_1))
                                eax_22, edx_1 = sub_6ba65f(eax_22, edx_1, arg1, &result_1)
                                eax_22.b = ebx[1]
                                var_244_1 = &ebx[2]
                            ...
                            eax_14, edx = sub_6ba65f(eax_22, edx_1, arg1, &result_1)
                    else if (edx.b == 0x68)
                        var_214 |= 0x20
                    else if (edx.b == 0x6c)
                        if (ebx[1] != 0x6c)
                ...
                case 7
                    ...
                    if (eax_14 s> 0x64)
                        ...
                        label_6ba0d3:
                            ...
                            if (i_5 s< 0)
                                ...
                                if (i_5 s> 0xa3)
                                    char* eax_41
                                    eax_41, edx = sub_6b8223(i_5 + 0x15d)
                                    edx.b = var_215_1
                                    var_24c_1 = eax_41
                            ...
                            var_220 = edi_1 + 8
                            DecodePointer(data_78d1c8)(&var_284, ebx_6, var_264_1, sx.d(edx.b), 
                                i_5, var_27c, &var_260)
                            int32_t edi_12 = var_214 & 0x80
                            
                            if (edi_12 != 0 && i_5 == 0)
                                DecodePointer(data_78d1d4)(ebx_6, &var_260)
                            
                            if (var_215_1 == 0x67 && edi_12 == 0)
                                DecodePointer(data_78d1d0)(ebx_6, &var_260)
                    ...
                    label_6ba410:
                        ...
                        if (var_248 == 0)
                            ...
                            uint32_t eax_66
                            uint32_t edx_4
                            eax_66, edx_4 = sub_6ba692(&result_1, eax_2, edx, ecx_24)
                            ...
                            if ((var_214.b & 8) != 0 && (var_214.b & 4) == 0)
                                ...
                                while (i_2 s> 0)
                                    ...
                                    eax_66.b = 0x30
                                    i_2 -= 1
                                    eax_66, edx_4 = sub_6ba65f(eax_66, edx_4, ecx_25, &result_1)
                            ...
                            if (var_240 == 0 || eax_67 s<= 0)
                                ...
                                eax_14, edx = sub_6ba692(&result_1, eax_2, edx_4, ecx_25)
                            else
                                char* esi_12 = var_224
                                ...
                                while (true)
                                    ...
                                    eax_14, edx = sub_6ba692(&result_1, eax_2, edx, ecx_26)
                            ...
                            if (result_1 s>= 0 && (var_214.b & 4) != 0)
                                ...
                                while (i_3 s> 0)
                                    eax_14.b = 0x20
                                    i_3 -= 1
                                    eax_14, edx = sub_6ba65f(eax_14, edx, arg1, &result_1)

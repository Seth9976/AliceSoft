...
if (*(arg1 + 0x80) == 0)
    ...
    *(arg1 + 0x80) = eax_6
    ...
    int32_t var_1c_1 = 0
    char var_2c = 0
    sub_401270(&var_2c, 0x15, "DPPartsSubSplitWindow")
    int32_t var_4_2 = 1
    sub_658360(&var_2c, *(arg1 + 0x80), arg2, *(arg1 + 0x18), *(arg1 + 0x5c), *(arg1 + 0x60), 
        *(arg1 + 0x64), *(arg1 + 0x78))
...
BOOL result = *(arg1 + 0x84)

if (result != 0)
    sub_658d70(*(arg1 + 0x80), result, 0, 0)
    sub_658d70(*(arg1 + 0x80), *(arg1 + 0x88), 0, 1)
    result.b = 1
else
    result.b = 0

...
int32_t var_1c = 0
char var_2c = 0
sub_401270(&var_2c, 0x11, "DPPartsInfoWindow")
int32_t var_4 = 0

if (*(arg1 + 0x90) == 0)
    struct dpparts::CWindow::VTable** eax_6 = operator new(0x90)
    var_4.b = 1
    struct dpparts::CWindow::VTable** eax_13
    ...
    if (eax_6 == 0)
        ...
        eax_13 = sub_651450(eax_8, eax_7, eax_6, *(arg1 + 0x18), var_3c, eax_10, eax_9)
    
    var_4.b = 0
    *(arg1 + 0x90) = eax_13
    eax_13[0x23] = arg1 + 0x94
    *(*(arg1 + 0x90) + 0x7c) = *(arg1 + 0x84)

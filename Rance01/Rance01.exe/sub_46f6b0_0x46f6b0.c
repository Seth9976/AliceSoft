...
float var_218 = fconvert.s(fconvert.t(arg7[1]))
float var_244 = fconvert.s(fconvert.t(*arg9))
float var_260 = fconvert.s(fconvert.t(arg9[1]))
...
float var_278 = fconvert.s(fconvert.t(arg11[1]))
                ...
                if (j_2 s> 0)
                    ...
                    do
                        if (not(xmm1_11 f< 0) && not(xmm2_3 f< 0) && not(xmm4_3 f< 0)
                            ...
                            int32_t edx_8
                            edx_8.b = *esi_3
                            char* ecx_8 = int.d(__minss_xmmss_memss(_mm_max_ss(xmm3_7, 0), xmm0_18))
                                * var_1a8.d + var_228.d + (
                                int.d(__minss_xmmss_memss(__maxss_xmmss_memss(xmm0_23, 0), xmm0_17))
                                << 2)
                            int32_t var_1f4_1 = 0
                            char ebx_8 = (((zx.d(*ecx_8) - zx.d(edx_8.b)) * arg4) s>> 8).b + edx_8.b
                            edx_8.b = esi_3[1]
                            *esi_3 = ebx_8
                            xmm6_10 = var_27c_10
                            char eax_31 =
                                (((zx.d(ecx_8[1]) - zx.d(edx_8.b)) * arg4) s>> 8).b + edx_8.b
                            edx_8.b = esi_3[2]
                            esi_3[1] = eax_31

    ...
    do
        ...
        if (edx_14 != 0)
            ...
            if (j_6 s> 0)
                ...
                do
                    ...
                    uint32_t ebx_3 = zx.d(xmm3_9.b) - eax_19
                    eax_19.b = *(esi_1 + 1)
                    *esi_1 += ((ebx_3 * ecx_28) s>> 8).b
                    char edx_20 =
                        (((zx.d(xmm3_9:1.b) - zx.d(eax_19.b)) * ecx_28) s>> 8).b + eax_19.b
                    eax_19.b = *(esi_1 + 2)
                    *(esi_1 + 1) = edx_20
                    *(esi_1 + 2) =
                        (((zx.d(xmm3_9:2.b) - zx.d(eax_19.b)) * ecx_28) s>> 8).b + eax_19.b
                    esi_1 += 4
                    edi_1 += 4
                    j = j_3
                    j_3 -= 1
        ...
        if (result s> 0)
            ...
            do
                ...
                int32_t xmm0_3[0x4] = xmm1_2 & _mm_srli_epi32(
                    _mm_adds_epu8(__pmullw_xmmdq_memdq(xmm1_2 & _mm_srli_epi32(xmm6_1, 8), xmm5_3), 
                        xmm7) & xmm3_1, 
                    8)
                ...
                int32_t xmm4_2[0x4] = xmm1_2 & xmm3_14
                int32_t xmm5_5[0x4] = xmm1_2 & _mm_srli_epi32(xmm3_14, 8)
                int32_t xmm3_21[0x4] = _mm_adds_epu8(
                    _mm_srli_epi16(__pmullw_xmmdq_memdq(xmm1_2 & xmm6_1, xmm1_2 & xmm3_2), 8), xmm7)
                    & xmm1_2
                int32_t xmm0_4[0x4] = _mm_subs_epi16(xmm0_3, xmm5_5)
                int32_t xmm3_22[0x4] = _mm_subs_epi16(xmm3_21, xmm4_2)
                int32_t xmm0_5[0x4] = _mm_mullo_epi16(xmm0_4, xmm2_10)
                int32_t xmm3_23[0x4] = _mm_mullo_epi16(xmm3_22, xmm2_10)
                int32_t xmm0_6[0x4] = _mm_srli_epi16(xmm0_5, 8)
                int32_t xmm3_24[0x4] = _mm_srli_epi16(xmm3_23, 8)
                int32_t xmm0_7[0x4] = _mm_adds_epi16(xmm0_6, xmm5_5)
                *esi_1 = _mm_adds_epi16(xmm3_24, xmm4_2) | _mm_slli_epi32(xmm0_7, 8)
                esi_1 = &esi_1[1]
                edi_1 = &edi_1[1]
                j_1 = result
                result -= 1
            ...
            do
                ...
                int32_t xmm3_32 = _mm_adds_epu8(
                    _mm_packus_epi16(
                        ...
                        zx.o(0)), 
                    xmm4)
                uint32_t ecx_29 = zx.d(xmm3_32:3.b)
                uint32_t ebx_9 = zx.d(xmm3_32.b) - result
                result.b = *(esi_1 + 1)
                *esi_1 += ((ebx_9 * ecx_29) s>> 8).b
                char edx_29 = (((zx.d(xmm3_32:1.b) - zx.d(result.b)) * ecx_29) s>> 8).b + result.b
                result.b = *(esi_1 + 2)
                *(esi_1 + 1) = edx_29
                *(esi_1 + 2) = (((zx.d(xmm3_32:2.b) - zx.d(result.b)) * ecx_29) s>> 8).b + result.b
                esi_1 += 4
                edi_1 += 4
                j_2 = j_4
                j_4 -= 1

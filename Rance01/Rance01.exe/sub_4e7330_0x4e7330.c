...
void* var_38 = nullptr
char var_48 = 0
sub_401270(&var_48, 0x11, 0x755b08)
int32_t var_4 = 0
char* ecx = var_48.d
...
if (((*(arg2 + 0x1e0) - *(arg2 + 0x1dc)) & 0xfffffffc) s> 0)
    int32_t i
    ...
    do
        ...
        void* var_6c
        var_6c.q = fconvert.d(fconvert.t(*(*(arg2 + 0x1dc) + (i_1 << 2))))
        ...
        i = i_1 + 1
        i_1 = i
    while (i s< (*(arg2 + 0x1e0) - *(arg2 + 0x1dc)) s>> 2)

int32_t var_18 = 0xf
int32_t var_1c = 0
char var_2c = 0
sub_401270(&var_2c, 2, 0x755b28)
int32_t var_4_6 = 3

...
float var_1d0 = fconvert.s(fconvert.t(*arg8))
...
float var_1ec = fconvert.s(fconvert.t(arg7[1]))
float var_1cc = fconvert.s(fconvert.t(*arg9))
...
double var_140 = fconvert.d(x87_r2)
...
long double x87_r5_2 =
    fconvert.t(fconvert.s(fconvert.t(var_140) - fconvert.t(fconvert.d(x87_r1_5))))
long double x87_r2_21 =
    fconvert.t(fconvert.s(x87_r7_14 * fconvert.t(var_1dc) - x87_r2 * fconvert.t(var_1a4)))
...
long double x87_r2_25 = fconvert.t(fconvert.s(
    ...
    + x87_r5 * fconvert.t(fconvert.s(x87_r2_17 - fconvert.t(var_140)))
...
if (p)
    ...
    double var_188_1
    var_188_1.d = (*(*arg12 + 8))(0, 0)
    double var_148
    var_148.d = (*(*arg12 + 0x1c))()
    int32_t eax_8 = (*(*arg12 + 0x10))() - 1
    double var_1d8
    var_1d8.d = (*(*arg12 + 0x14))() - 1
    float var_1c4_2 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_1c4) / fconvert.t(arg6[3]))))
    float var_1cc_2 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_1cc) / fconvert.t(arg8[3]))))
    float var_1e0_2 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_1e0) / fconvert.t(arg2[3]))))
    float var_1ec_2 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_1ec) / fconvert.t(arg6[3]))))
    float var_1f4_2 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_1f4) / fconvert.t(arg8[3]))))
    float var_200_2 = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_200) / fconvert.t(arg2[3]))))
    arg6[3]
    long double x87_r6_12 = float.t(1)
    float var_200_6 = fconvert.s(fconvert.t(fconvert.s(x87_r6_12 / fconvert.t(arg8[3]))))
    float var_200_8 = fconvert.s(fconvert.t(fconvert.s(x87_r6_12 / fconvert.t(arg2[3]))))
    ...
    long double x87_r7_53 = fconvert.t(var_1a4)
    ...
    int32_t j_3 = edi_1 - var_1dc_1
    float var_200_16 = fconvert.s(fconvert.t(var_180_1))
    float var_1f4_3 = fconvert.s(fconvert.t(var_1c0_1))
    float var_1ec_3 = fconvert.s(fconvert.t(var_1a0_1))
    var_140.o = zx.o(0)
    ...
    void* esi_3 = (*(*arg4 + 8))(var_1dc_1, esi_2)
    int32_t j_2 = j_3
    var_1d8.d = fconvert.s(float.t(esi_2))
    result = (*(*arg4 + 0x1c))() - (j_2 << 2)
    long double x87_r7_69 = fconvert.t(var_1d8.d)
    float* result_1 = result
    var_1d8.d = fconvert.s(x87_r7_69 * fconvert.t(var_17c_1) + fconvert.t(fconvert.s(
        fconvert.t(fconvert.s(x87_r5 * x87_r2 - x87_r4_2 * x87_r7_14)) * x87_r3_7)))
    int128_t xmm3_1 = var_1d8.d
    float var_170
    var_170.o = xmm3_1
    int128_t xmm5_1 = fconvert.s(x87_r7_69 * fconvert.t(var_1bc_1) + fconvert.t(fconvert.s(
        fconvert.t(fconvert.s(x87_r2_5 * x87_r4_2 - x87_r1_5 * x87_r5)) * x87_r3_7)))
    float var_160
    var_160.o = xmm5_1
    int128_t xmm6_1 =
        fconvert.s(x87_r7_69 * fconvert.t(var_19c_1) + fconvert.t(fconvert.s(x87_r3_7 * x87_r2_21)))
    int128_t var_130_1 = xmm6_1
    var_1d8.d = fconvert.s(float.t(var_1dc_1))
    long double x87_r7_73 = fconvert.t(var_1d8.d)
    var_1d8.d = fconvert.s(x87_r7_73 * fconvert.t(var_180_1))
    long double x87_r7_74 = x87_r7_73 * fconvert.t(var_1a0_1)
    var_1a0_1.o = var_1d8.d
    var_1c0_1.o = fconvert.s(x87_r7_73 * fconvert.t(var_1c0_1))
    ...
    if (i_2 s> 0)
        ...
        do
            float xmm0_22 = var_1a0_1 f+ xmm3_1
            float xmm1_11 = var_1c0_1 f+ xmm5_1
            float xmm2_2 = var_180_1 f+ xmm6_1
            ...
            if (j_2 s> 0)
                ...
                do
                    ...
                    int32_t edx_9
                    edx_9.b = *esi_3
                    int32_t eax_25 = int.d(__minss_xmmss_memss(
                        _mm_max_ss(
                            (xmm0_22 * var_1ec_2 + xmm1_11 * var_1f4_2 + xmm2_2 * var_200_2)
                                * xmm5_6, 
                            0), 
                        xmm0_17)) * var_148.d + var_188_1.d
                    int32_t ecx_8 = int.d(__minss_xmmss_memss(
                        _mm_max_ss(
                            (xmm0_22 * var_1c4_2 + xmm1_11 * var_1cc_2 + xmm2_2 * var_1e0_2)
                                * xmm5_6, 
                            0), 
                        fconvert.s(float.t(eax_8))))
                    void* edi_3 = eax_25 + (ecx_8 << 2)
                    uint32_t eax_26
                    eax_26.b = *(esi_3 + 1)
                    int32_t ecx_11 = (zx.d(*(edi_3 + 3)) * arg11) s>> 8
                    *esi_3 = (((zx.d(*(eax_25 + (ecx_8 << 2))) - zx.d(edx_9.b)) * ecx_11) s>> 8).b
                        + edx_9.b
                    char edx_13 =
                    ...
                    *(esi_3 + 1) = edx_13
                    edx_9.b = (((zx.d(*(edi_3 + 2)) - zx.d(eax_26.b)) * ecx_11) s>> 8).b + eax_26.b
                    *(esi_3 + 2) = edx_9.b
                    esi_3 += 4
                    j = j_1
                    j_1 -= 1
            ...
            xmm5_1 = xmm5_1 f+ fconvert.s(fconvert.t(var_1bc_1))
            xmm6_1 = xmm6_1 f+ fconvert.s(fconvert.t(var_19c_1))
            esi_3 += result
            i = i_1
            i_1 -= 1
            var_170.o = xmm3_1

...
if (p)
    ...
    double var_198_1
    var_198_1.d = (*(*arg12 + 8))(0, 0)
    double var_158
    var_158.d = (*(*arg12 + 0x1c))()
        ...
        do
            ...
            if (j_2 s> 0)
                ...
                do
                    ...
                    int32_t edx_9
                    edx_9.b = *esi_3
                    int32_t eax_26 = (eax_23 s>> 7) * var_158.d + var_198_1.d
                    ...
                    void* edi_3 = eax_26 + (ecx_9 << 2)
                    uint32_t eax_27
                    eax_27.b = *(esi_3 + 1)
                    int32_t ecx_12 = (zx.d(*(edi_3 + 3)) * arg11) s>> 8
                    *esi_3 = (((zx.d(*(eax_26 + (ecx_9 << 2))) - zx.d(edx_9.b)) * ecx_12) s>> 8).b
                        + edx_9.b
                    char edx_13 =
                    ...
                    *(esi_3 + 1) = edx_13
                    edx_9.b = (((zx.d(*(edi_3 + 2)) - zx.d(eax_27.b)) * ecx_12) s>> 8).b + eax_27.b
                    *(esi_3 + 2) = edx_9.b
                    esi_3 += 4
                    j = j_1
                    j_1 -= 1

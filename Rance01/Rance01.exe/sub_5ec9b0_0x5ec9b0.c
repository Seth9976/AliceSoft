...
void* var_f4 = esi
sub_5ed2d0(eax_11, edx_2, arg5, i, esi - 0x6c)
void* i_4 = i + 0x6c
...
while (true)
    ...
    for (; i_1 u< esi; i_1 += 0x6c)
        ...
        if (eax_14 s<= ecx_5)
            ...
            void* i_8 = i_4
            i_4 += 0x6c
            sub_5ec740(i_8, &var_e8)
            int32_t var_4 = 0
            *i_8 = fconvert.s(fconvert.t(*i_1))
            *(i_8 + 4) = fconvert.s(fconvert.t(*(i_1 + 4)))
            *(i_8 + 8) = *(i_1 + 8)
            *(i_8 + 0xc) = *(i_1 + 0xc)
            ...
            *i_1 = fconvert.s(fconvert.t(var_e8))
            *(i_1 + 4) = fconvert.s(fconvert.t(var_e4))
            *(i_1 + 8) = var_e0
            *(i_1 + 0xc) = var_dc
    ...
    if (i_7 u> arg5)
        ...
        do
            ...
            if (ecx_14 s<= eax_25)
                ...
                sub_5ec740(i, &var_e8)
                int32_t var_4_2 = 1
                *i = fconvert.s(fconvert.t(i_12[-2]))
                *(i + 4) = fconvert.s(fconvert.t(i_12[-1]))
                *(i + 8) = *i_12
                *(i + 0xc) = i_12[1]
                sub_401180(i + 0x10, 0xffffffff, &i_12[2], 0)
                sub_401180(i + 0x2c, 0xffffffff, &i_12[9], 0)
                *(i + 0x48) = i_12[0x10].b
                sub_5ec870(i + 0x4c, &i_12[0x11])
                sub_4b55f0(i + 0x5c, &i_12[0x15])
                i_12[-2] = fconvert.s(fconvert.t(var_e8))
                i_12[-1] = fconvert.s(fconvert.t(var_e4))
                i_12[1] = var_dc
                *i_12 = var_e0
                sub_401180(&i_12[2], 0xffffffff, &var_d8, 0)
                sub_401180(&i_12[9], 0xffffffff, &var_bc, 0)
                i_12[0x10].b = var_a0
                sub_5ec870(&i_12[0x11], &var_9c)
                sub_4b55f0(&i_12[0x15], &var_8c)
    ...
    if (cond:2_1)
        ...
        if (i_1 != esi)
            ...
            *i_2 = fconvert.s(fconvert.t(var_7c))
            float var_78
            *(i_2 + 4) = fconvert.s(fconvert.t(var_78))
            int32_t var_70
            *(i_2 + 0xc) = var_70
            int32_t var_74
            *(i_2 + 8) = var_74
            ...
            *(i_2 + 0x48) = var_34
            ...
            if (i_7 - 0x6c != i)
                sub_5ec740(i_7 - 0x6c, &var_e8)
                int32_t var_4_7 = 4
                *i_2 = fconvert.s(fconvert.t(*i))
                *(i_2 + 4) = fconvert.s(fconvert.t(*(i + 4)))
                *(i_2 + 8) = *(i + 8)
                *(i_2 + 0xc) = *(i + 0xc)
                ...
                *i = fconvert.s(fconvert.t(var_e8))
                *(i + 4) = fconvert.s(fconvert.t(var_e4))
                *(i + 8) = var_e0
                *(i + 0xc) = var_dc
            ...
            sub_5ec740(i, &var_e8)
            int32_t var_4_9 = 5
            *i = fconvert.s(fconvert.t(*i_4))
            *(i + 4) = fconvert.s(fconvert.t(*(i_4 + 4)))
            *(i + 8) = *(i_4 + 8)
            *(i + 0xc) = *(i_4 + 0xc)
            ...
            *i_4 = fconvert.s(fconvert.t(var_e8))
            *(i_4 + 4) = fconvert.s(fconvert.t(var_e4))
            *(i_4 + 8) = var_e0
            *(i_4 + 0xc) = var_dc
        ...
        i += 0x6c
        i_1 += 0x6c
        sub_5ec740(i_3, &var_e8)
        float* i_9 = i_6
        int32_t var_4_6 = 3
        *i_9 = fconvert.s(fconvert.t(*i_5))
        i_9[1] = fconvert.s(fconvert.t(i_5[1]))
        i_9[2] = i_5[2]
        i_9[3] = i_5[3]
        sub_401180(&i_9[4], 0xffffffff, &i_5[4], 0)
        sub_401180(&i_6[0xb], 0xffffffff, &i_5[0xb], 0)
        int32_t* i_10 = i_6
        i_10[0x12].b = i_5[0x12].b
        sub_5ec870(&i_10[0x13], &i_5[0x13])
        sub_4b55f0(&i_6[0x17], &i_5[0x17])
        *i_5 = fconvert.s(fconvert.t(var_e8))
        i_5[1] = fconvert.s(fconvert.t(var_e4))
        i_5[3] = var_dc
        i_5[2] = var_e0

...
if ((0x7ffff & xmm0) - 0x3fb00 u< 0x3bb)
    ...
    double xmm1_2 = *((((xmm0 & 0xfffc) - 0xfb00) << 1) + &data_763260)
    ...
    uint64_t xmm4_1[0x2] = _mm_xor_pd(*((((xmm0 & 0xfffc) - 0xfb00) << 2) + &data_762360), 
...
if ((0x7ffff & xmm0) - 0x3febb u< 0x43)
    ...
    double xmm7_3 = __andpd_xmmxuq_memxuq(xmm7, *0x763a90)
    ...
    double xmm7_6 = xmm3_7.q f* *((edx_6 << 2) + &data_763260)
    double xmm6_9 = xmm7_3 * xmm2_6 - xmm7_6 + xmm1_8 * xmm2_6
    double xmm3_10[0x2] = __subpd_xmmpd_mempd(data_763a60, *((edx_6 << 3) + &data_762360))
...
if ((0x7ffff & xmm0) - 0x3c300 u< 0x3800)
    ...
    double xmm6_12[0x2] = data_763ab0
    double xmm1_13[0x2] = _mm_unpacklo_pd(xmm1, xmm7_9)
    double xmm2_8[0x2] = data_763ac0
    double xmm4_7[0x2] = data_763ad0
...
if ((0x7ffff & xmm0) - 0x3fefe u>= 2)
    ...
    var_c = xmm0_30
    sub_6b7e6f(&arg4, &arg4, &var_c, edx_11)
    var_c = var_c
    return fconvert.t(var_c)
...
double xmm7_12 = __andpd_xmmxuq_memxuq(xmm7, data_763a80)
double xmm5_6 = _mm_shuffle_epi32(xmm3_14, 0x44)
double xmm3_15 = __andpd_xmmxuq_memxuq(xmm3_14, data_763a80)
double xmm0_19 = xmm0_1 f- xmm7_12
double xmm6_17 = xmm3_15 - xmm5_6
uint32_t xmm5_7[0x4] = xmm5_6 + xmm5_6
double xmm2_10[0x2] = data_763ab0
...
double xmm5_10[0x2] = data_763ac0
double xmm0_21[0x2] = data_763ad0
...
uint32_t xmm0_22[0x4] = data_763a60

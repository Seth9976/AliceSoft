...
sub_641c80(arg4, edx_3, arg2, esi_3, arg3 - 0x8c, arg4)
    ...
    do
        ...
        if (edx_5 s<= esi_4)
            ...
            if (edi_1 s<= ebx_2)
                ...
                if (edi_2 s<= ebx_3 && *(ecx_3 - 0x28) s< *eax_7)
                    break
        ...
        if (esi_4 s<= edx_5)
            ...
            if (esi_5 s<= edx_6)
                ...
                if (esi_6 s<= edx_7 && *eax_7 s< *(ecx_3 - 0x28))
                    break
...
if (edx_4 u< arg3)
    int32_t edi_4 = eax_7[9]
    
    do
        ecx_3 = edx_4[9]
        int32_t esi_7 = edx_4[0xa]
        int32_t ebx_4 = edx_4[0xb]
        
        if (ecx_3 s< edi_4)
            break
        
        if (ecx_3 s<= edi_4)
            int32_t edi_5 = eax_7[0xa]
            
            if (esi_7 s< edi_5)
                break
            
            if (esi_7 s<= edi_5)
                int32_t edi_6 = eax_7[0xb]
...
while (true)
    if (ebx_5 u< arg3)
        do
            int32_t ecx_6 = eax_7[9]
            int32_t edx_9 = ebx_5[9]
            int32_t esi_8 = eax_7[0xa]
            int32_t edi_8 = ebx_5[0xa]
            ...
            if (ecx_6 s>= edx_9)
                ...
                label_63f58a:
                    ...
                    if (edx_9 s<= ecx_6)
                        int32_t ecx_7 = eax_7[0xa]
                        int32_t edx_10 = ebx_5[0xa]
                        
                        if (edx_10 s< ecx_7)
                            break
                        
                        if (edx_10 s<= ecx_7)
                            int32_t ecx_8 = eax_7[0xb]
                            int32_t edx_11 = ebx_5[0xb]
                    ...
                    int32_t esi_9 = eax_7[0xb]
                    int32_t edi_9 = ebx_5[0xb]
    ...
    if (esi_23 u> arg2)
        int32_t* edx_14 = esi_23 - 0x64
        
        do
            int32_t ecx_11 = edx_14[-1]
            int32_t esi_13 = eax_7[9]
            int32_t edi_12 = eax_7[0xa]
            
            if (ecx_11 s>= esi_13)
                if (ecx_11 s> esi_13)
                label_63f63a:
                    int32_t esi_17 = eax_7[9]
                    ...
                    if (esi_17 s<= ecx_11)
                        ...
                        if (esi_18 s<= ecx_12)
                            ...
                            if (esi_19 s<= ecx_13 && *eax_7 s< edx_14[-0xa])
                                esi_23 = var_400
                                break
                    ...
                    __builtin_memcpy(eax_7, &edx_14[-0xa], 0x8c)
                    __builtin_memcpy(&edx_14[-0xa], &var_3f8, 0x8c)
                else
                    ...
                    if (esi_14 s>= edi_12)
                        ...
                        int32_t edi_13 = eax_7[0xb]
                        int32_t esi_15 = edx_14[1]
                        
                        if (esi_15 s>= edi_13 && (esi_15 s> edi_13 || edx_14[-0xa] s>= *eax_7))
                            goto label_63f63a

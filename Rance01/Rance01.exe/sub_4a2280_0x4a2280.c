...
arg16 = fconvert.s(fconvert.t(*edx_2))
float var_18 = fconvert.s(fconvert.t(edx_2[1]))
float var_1c = fconvert.s(fconvert.t(*ebx))
float var_20 = fconvert.s(fconvert.t(ebx[1]))
float var_14 = fconvert.s(fconvert.t(*eax))
float* eax_1 = arg7
float var_8 = fconvert.s(fconvert.t(eax[1]))
float var_28 = fconvert.s(fconvert.t(*eax_1))
float* result = arg9
float var_24 = fconvert.s(fconvert.t(eax_1[1]))
...
long double x87_r4_2 = fconvert.t(var_1c)
long double x87_r2 = fconvert.t(arg16)
...
if (p)
    ...
    float var_74_1 = fconvert.s(fconvert.t(var_28) / fconvert.t(*(arg6 i+ 0xc)))
    float var_c8_1 = fconvert.s(fconvert.t(arg9) / fconvert.t(*(arg8 i+ 0xc)))
    float var_c4_1 = fconvert.s(fconvert.t(var_2c) / fconvert.t(ebx[3]))
    ...
    float var_84_1 = fconvert.s(fconvert.t(var_c) / fconvert.t(ebx[3]))
    *(arg6 i+ 0xc)
    long double x87_r6_12 = float.t(1)
    float var_b0_1 = fconvert.s(x87_r6_12 / fconvert.t(*(arg8 i+ 0xc)))
    float var_c0_1 = fconvert.s(x87_r6_12 / fconvert.t(ebx[3]))
    long double x87_r7_39 = fconvert.t(arg11)
    long double x87_r6_16 = fconvert.t(arg16)
    x87_r6_16 - x87_r7_39
    float eax_12
    ...
    long double x87_r5_5 = fconvert.t(var_1c)
    ...
    long double x87_r5_8 = fconvert.t(var_20)
    ...
    float var_14_1 = fconvert.s(x87_r7_54 * fconvert.t(var_40_1) + fconvert.t(fconvert.s(
    ...
    if (i_2 s> 0)
        ...
        do
            float var_8_1 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_5c_1)))
                + fconvert.t(var_18_1))
            float var_20_1 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_44_1)))
                + fconvert.t(var_14_1))
            float var_4_2 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_38_1)))
                + fconvert.t(var_1c_1))
            
            if (j_2 s> 0)
                double var_90
                var_90:4.d = zx.d(arg7:3.b)
                double var_a0
                var_a0:4.d = zx.d(arg9:3.b)
                double var_50_1
                ...
                do
                    long double x87_r6_42 = fconvert.t(var_20_1)
                    long double x87_r4_20 = fconvert.t(var_8_1)
                    ...
                    int32_t ebx_5 = sub_70c710(fconvert.t(fconvert.s((
                        x87_r6_42 * fconvert.t(var_c8_1) + x87_r4_20 * fconvert.t(var_74_1)
                        + x87_r3_30 * fconvert.t(var_c4_1)) * x87_r2_38)) * x87_r7_60) s>> 8
                    int32_t eax_34 = sub_70c710(fconvert.t(fconvert.s(x87_r2_38 * (
                        x87_r6_42 * fconvert.t(var_6c_1) + x87_r4_20 * fconvert.t(var_b4_1)
                    ...
                    if (eax_34 s< 0)
                        eax_34 = 0
                    else if (eax_34 s> eax_10 - 1)
                        eax_34 = eax_10 - 1
                    
                    var_8_1 = fconvert.s(x87_r4_20 + fconvert.t(var_5c_1))
                    var_20_1 = fconvert.s(x87_r6_42 + fconvert.t(var_44_1))
                    esi_3 += 4
                    int32_t eax_37 = *(eax_34 * eax_5 + eax_3 + (ebx_5 << 2))
                    int32_t var_4_3
                    var_4_3:1.b =
                        *(((zx.d(eax_37:1.b) * zx.d(arg11:3.b)) s>> 8) + zx.d(arg10:3.b) + edi)
                    void* eax_49 = ((zx.d(var_4_3:3.b) * var_a0:4.d) s>> 8) + var_50_1:4.d
                    var_4_3:2.b = (((zx.d(eax_37:2.b) * zx.d(arg16:3.b)) s>> 8) + var_90:4.d)[edi]
                    char ecx_19 = *(esi_3 - 4)
                    int32_t eax_52 = (zx.d(*(eax_49 + edi)) * arg12) s>> 8
                    char edx_23 = (((
                        zx.d(*(((zx.d(eax_37.b) * zx.d(arg6:3.b)) s>> 8) + zx.d(arg8:3.b) + edi))
                        - zx.d(ecx_19)) * eax_52) s>> 8).b + ecx_19
                    ecx_19 = *(esi_3 - 3)
                    *(esi_3 - 4) = edx_23
                    char ebx_10 = (((zx.d(var_4_3:1.b) - zx.d(ecx_19)) * eax_52) s>> 8).b + ecx_19
                    ecx_19 = *(esi_3 - 2)
                    *(esi_3 - 3) = ebx_10
                    var_4_2 = fconvert.s(x87_r3_30 + fconvert.t(var_38_1))
                    j = j_1
                    j_1 -= 1
                    *(esi_3 - 2) = (((zx.d(var_4_3:2.b) - zx.d(ecx_19)) * eax_52) s>> 8).b + ecx_19
                while (j != 1)
                result = var_68:4.d
                j_2 = j_3
            ...
            var_14_1 = fconvert.s(fconvert.t(var_14_1) + fconvert.t(var_40_1))
            var_1c_1 = fconvert.s(fconvert.t(var_1c_1) + fconvert.t(var_34_1))
        while (i != 1)

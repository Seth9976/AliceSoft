...
float var_194 = fconvert.s(fconvert.t(*arg6))
float var_164 = fconvert.s(fconvert.t(arg6[1]))
float var_17c = fconvert.s(fconvert.t(*arg8))
float var_198 = fconvert.s(fconvert.t(arg8[1]))
float var_178 = fconvert.s(fconvert.t(*arg2))
float var_19c = fconvert.s(fconvert.t(arg2[1]))
float var_1a4 = fconvert.s(fconvert.t(*arg10))
float var_1a0 = fconvert.s(fconvert.t(arg10[1]))
float var_128 = fconvert.s(fconvert.t(*arg7))
float var_190 = fconvert.s(fconvert.t(arg7[1]))
float var_12c = fconvert.s(fconvert.t(*arg9))
...
if (p)
    ...
    void* esi_3 = (*(*arg4 + 8))(var_194_1, esi_2)
    int32_t j_2 = j_3
        ...
        do
            ...
            if (j_2 s> 0)
                ...
                do
                    ...
                    void* edi_5 = eax_26 + (ecx_7 << 2)
                    uint32_t eax_27
                    eax_27.b = *(esi_3 + 1)
                    int32_t ecx_10 = (zx.d(*(edi_5 + 3)) * arg11) s>> 8
                    *esi_3 = (((zx.d(*(eax_26 + (ecx_7 << 2))) - zx.d(edx_8.b)) * ecx_10) s>> 8).b
                        + edx_8.b
                    char edx_12 =
                    ...
                    *(esi_3 + 1) = edx_12
                    edx_8.b = (((zx.d(*(edi_5 + 2)) - zx.d(eax_27.b)) * ecx_10) s>> 8).b + eax_27.b
                    *(esi_3 + 2) = edx_8.b
                    esi_3 += 4
                    j = j_1
                    j_1 -= 1

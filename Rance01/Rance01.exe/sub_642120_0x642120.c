    ...
    while (true)
        ...
        if (result_6 s< ecx_4)
            do
                ...
                int32_t esi_5 = *(ecx_2 + arg2 + 0x30)
                int32_t edi_1 = *(ecx_2 + arg2 - 0x5c)
                int32_t eax_7 = *(ecx_2 + arg2 - 0x54)
                void* ecx_3 = ecx_2 + arg2
                
                if (esi_5 s< edi_1)
                    result_6 -= 1
                else if (esi_5 s<= edi_1)
                    int32_t esi_6 = *(ecx_3 + 0x34)
                    int32_t edi_2 = *(ecx_3 - 0x58)
                    
                    if (esi_6 s< edi_2)
                        result_6 -= 1
                    else if (esi_6 s<= edi_2)
                        int32_t esi_7 = *(ecx_3 + 0x38)
        ...
        result = sub_643a20(result_4, result_6, arg3, arg2)

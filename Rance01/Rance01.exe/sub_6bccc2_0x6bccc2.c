...
int32_t __saved_ebp
int32_t var_8 = data_78c474 ^ &__saved_ebp
int32_t edi
int32_t var_c = edi
...
if (arg4 == 0)
    ...
    int32_t ebx
    int32_t var_10 = ebx
    int32_t eax_7 = (&data_798100)[arg2 s>> 5]
    ...
    label_6bcd87:
        ...
        if ((*(eax_7 + edi_3 + 4) & 0x20) != 0)
            sub_6b5a9a(eax_7, edx, ecx, arg2, 0, 0, FILE_END)
        
        enum CONSOLE_MODE var_1ae4
        uint32_t numberOfBytesWritten_1
        enum WIN32_ERROR wideCharStr
        
        if (sub_6c1d00(arg2) == 0 || (*(edi_3 + (&data_798100)[arg2 s>> 5] + 4) & 0x80) == 0)
        label_6bd042:
            int32_t* eax_34 = (&data_798100)[arg2 s>> 5]
                ...
                if (var_1ac5_1 != 0)
                    if (var_1ac5_1 == 2)
                        ...
                        do
                            ...
                            if (WriteFile(*(edi_3 + (&data_798100)[arg2 s>> 5]), &buffer, 
                    ...
                    do
                        ...
                        do
                            if (WriteFile(*(edi_3 + (&data_798100)[arg2 s>> 5]), 
            ...
            label_6bd376:
                ...
                if ((*(edi_3 + (&data_798100)[arg2 s>> 5] + 4) & 0x40) == 0 || *arg3 != 0x1a)
                    *__errno() = 0x1c
                    *___doserrno() = 0
                    result = 0xffffffff
                else
            ...
            if (GetConsoleMode(*(edi_3 + (&data_798100)[arg2 s>> 5]), &var_1ae4) == 0
                ...
                do
                    ...
                    if (eax_17.b != 0)
                        ...
                        if (eax_17.b == 1 || eax_17.b == 2)
                            ...
                            int16_t eax_32 = sub_6c2e19(wideCharStr_4)
                            ...
                            if (wideCharStr_5 != NO_ERROR)
                                ...
                                int16_t eax_33 = sub_6c2e19(wideCharStr_4)
                        ...
                        void* eax_19 = (&data_798100)[arg2 s>> 5] + edi_3
                        int32_t* var_18_3
                        int32_t var_14_4
                        
                        if (*(eax_19 + 0x38) == 0)
                            if (__ismbcupper(wideCharStr_4.b) == 0)
                                var_14_4 = 1
                                var_18_3 = ebx_2
                                goto label_6bceb0
                            ...
                            if (arg3 - ebx_2 + arg4 u<= 1)
                                numberOfBytesWritten_5 += 1
                                *(edi_3 + (&data_798100)[arg2 s>> 5] + 0x34) = *ebx_2
                                *(edi_3 + (&data_798100)[arg2 s>> 5] + 0x38) = 1
                                break
                            
                            if (__mbscat_s(&wideCharStr, ebx_2, 2) == 0xffffffff)
                                break
                        ...
                        label_6bceb0:
                            ...
                            if (__mbscat_s(&wideCharStr, var_18_3, var_14_4) == 0xffffffff)
                                break
                        ebx_2 = &ebx_2[1]
                        var_1ac4_1 += 1
                        ...
                        if (WriteFile(*(edi_3 + (&data_798100)[arg2 s>> 5]), &var_10, 
                        ...
                        if (wideCharStr_5 != NO_ERROR)
                            ...
                            eax_31, wideCharStr_4 = WriteFile(
                                *(edi_3 + (&data_798100)[arg2 s>> 5]), &var_10, 1, 

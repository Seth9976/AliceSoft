...
if (eax u< eax + 0x800)
    ...
    do
        ...
        *(eax_1 + 0x2f) = 0
        eax_1 += 0x40
    while (eax_1 - 5 u< data_798100 + 0x800)
...
label_6bca5b:
    ...
    while (true)
        int32_t* esi_9 = (ebx_1 << 6) + data_798100
        ...
        if (hFile != 0xffffffff && hFile != 0xfffffffe)
            ...
            if ((ecx_5.b & 1) != 0)
                ...
                if ((ecx_5.b & 8) != 0 || eax_7 != FILE_TYPE_UNKNOWN)
                    int32_t* esi_6 = ((edi_2 & 0x1f) << 6) + (&data_798100)[edi_2 s>> 5]
                    *esi_6 = *var_c_1
                    void* eax_12
                    eax_12.b = *var_8_1
                    esi_6[1].b = eax_12.b

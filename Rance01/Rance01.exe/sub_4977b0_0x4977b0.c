...
float var_40 = fconvert.s(fconvert.t(*arg8))
float var_5c = fconvert.s(fconvert.t(arg8[1]))
...
if (p)
    ...
    x87_r6_13 - x87_r7_24
    int32_t var_c_1 = sub_70c710(fconvert.t(fconvert.s(x87_r3_22)))
    int32_t eax_13
    ...
    x87_r6_18 - x87_r7_31
    int32_t var_8_1 = sub_70c710(fconvert.t(fconvert.s(x87_r3_26)))
    int32_t eax_16
    ...
    arg8:3.b = *arg13
    double var_4c_1
    var_4c_1:4.d = fconvert.s(x87_r7_37 * fconvert.t(var_5c) + x87_r5_10 * fconvert.t(var_44)
        + x87_r4_22 * fconvert.t(var_58))
    int32_t i_2 = eax_19 - var_8_1
    void* esi_1 = (*(*arg4 + 8))(var_c_1, var_8_1)
    int32_t j_2 = j_3
    result = (*(*arg4 + 0x1c))() - (j_2 << 2)
    var_74:4.d = result
    long double x87_r7_42 = fconvert.t(fconvert.s(float.t(var_8_1)))
    float var_8_2 = fconvert.s(x87_r7_42 * fconvert.t(var_64_1) + fconvert.t(fconvert.s(
        fconvert.t(fconvert.s(x87_r5 * x87_r2 - x87_r4_2 * x87_r7_14)) * x87_r3_7)))
    float var_10_1 = fconvert.s(x87_r7_42 * fconvert.t(var_34_1) + fconvert.t(fconvert.s(
        fconvert.t(fconvert.s(x87_r2_5 * x87_r4_2 - x87_r1_5 * x87_r5)) * x87_r3_7)))
    float var_1c_1 =
        fconvert.s(x87_r7_42 * fconvert.t(var_28_1) + fconvert.t(fconvert.s(x87_r3_7 * x87_r2_21)))
    ...
    if (i_2 s> 0)
        ...
        do
            ...
            long double x87_r5_17 = fconvert.t(fconvert.s(
                fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_38_1))) + x87_r5_13))
            ...
            long double x87_r2_33 = fconvert.t(fconvert.s(
                fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_2c_1))) + fconvert.t(var_1c_1)))
            float var_8_4 = fconvert.s(x87_r5_17 * fconvert.t(var_40)
                + x87_r3_30 * fconvert.t(var_54) + x87_r2_33 * fconvert.t(var_3c))
            float var_10_3 = fconvert.s(x87_r5_17 * fconvert.t(var_5c)
                + x87_r3_30 * fconvert.t(var_44) + x87_r2_33 * fconvert.t(var_58))
            
            if (j_2 s> 0)
                long double x87_r4_32 = fconvert.t(256.0)
                double var_84
                var_84:4.d = zx.d(eax_21)
                double var_94
                var_94:4.d = zx.d(eax_23)
                int32_t j_1 = j_2
                int32_t j
                
                do
                    long double x87_r3_32 = fconvert.t(var_8_4)
                    long double x87_r2_38 = fconvert.t(var_10_3)
                    int32_t ebx_5 = sub_70c710(x87_r3_32 * x87_r4_32) s>> 8
                    int32_t eax_35 = sub_70c710(x87_r2_38 * x87_r4_32) s>> 8
                    ...
                    if (eax_35 s< 0)
                        eax_35 = 0
                    else if (eax_35 s> var_bc_1)
                        eax_35 = var_bc_1
                    
                    var_8_4 = fconvert.s(x87_r3_32 + fconvert.t(fconvert.s(
                        x87_r7_37 * fconvert.t(var_40) + x87_r5_10 * fconvert.t(var_54)
                        + x87_r4_22 * fconvert.t(var_3c))))
                    esi_1 += 4
                    var_10_3 = fconvert.s(x87_r2_38 + fconvert.t(var_4c_1:4.d))
                    int32_t eax_38 = *(eax_35 * eax_5 + eax_3 + (ebx_5 << 2))
                    int32_t var_c_2
                    var_c_2:1.b =
                        *(((zx.d(eax_38:1.b) * zx.d(arg7:3.b)) s>> 8) + zx.d(arg9:3.b) + edi_1)
                    void* eax_50 = ((zx.d(var_c_2:3.b) * var_84:4.d) s>> 8) + var_94:4.d
                    var_c_2:2.b =
                        *(((zx.d(eax_38:2.b) * zx.d(arg6:3.b)) s>> 8) + zx.d(arg8:3.b) + edi_1)
                    char ecx_20 = *(esi_1 - 4)
                    int32_t eax_53 = (zx.d(*(eax_50 + edi_1)) * arg11) s>> 8
                    char edx_21 = (((zx.d(
                        *(((zx.d(eax_38.b) * zx.d(arg10:3.b)) s>> 8) + zx.d(arg15:3.b) + edi_1))
                        - zx.d(ecx_20)) * eax_53) s>> 8).b + ecx_20
                    ecx_20 = *(esi_1 - 3)
                    *(esi_1 - 4) = edx_21
                    char ebx_10 = (((zx.d(var_c_2:1.b) - zx.d(ecx_20)) * eax_53) s>> 8).b + ecx_20
                    ecx_20 = *(esi_1 - 2)
                    *(esi_1 - 3) = ebx_10
                    j = j_1
                    j_1 -= 1
                    *(esi_1 - 2) = (((zx.d(var_c_2:2.b) - zx.d(ecx_20)) * eax_53) s>> 8).b + ecx_20
                while (j != 1)
                result = var_74:4.d
                j_2 = j_3
                x87_r6_42 = x87_r4_32
            ...
            i = i_1
            i_1 -= 1
            var_8_2 = fconvert.s(x87_r6_38 + fconvert.t(var_64_1))
            var_10_1 = fconvert.s(x87_r6_42 + fconvert.t(var_34_1))
            var_1c_1 = fconvert.s(fconvert.t(var_1c_1) + fconvert.t(var_28_1))
        while (i != 1)

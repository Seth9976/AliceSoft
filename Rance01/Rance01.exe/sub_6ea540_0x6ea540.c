...
int32_t var_54 = data_79b9a8
int32_t var_50 = data_79b9ac
int32_t var_4c = data_79b9b0
int32_t var_48 = data_79b9b4
void var_44
...
if (zx.d(sub_6e0c40(&var_44, &var_54)) != 0)
    return (*(ebx + 0xc0))(ebp, ebp + 0x80, ebp + 0x100, edi_1, esi)
...
return sub_6e9d40(ebp, ebp + 0x80, ebp + 0x100, edi_1, &var_24, esi)

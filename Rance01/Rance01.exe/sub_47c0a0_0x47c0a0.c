...
float var_244 = fconvert.s(fconvert.t(*arg7))
float var_248 = fconvert.s(fconvert.t(arg7[1]))
float var_264 = fconvert.s(fconvert.t(*arg9))
float var_2a0 = fconvert.s(fconvert.t(arg9[1]))
float var_2a8 = fconvert.s(fconvert.t(*arg11))
float var_298 = fconvert.s(fconvert.t(arg11[1]))
float var_274 = fconvert.s(fconvert.t(*arg12))
float var_2ac = fconvert.s(fconvert.t(arg12[1]))
float var_26c = fconvert.s(fconvert.t(*arg8))
float var_29c = fconvert.s(fconvert.t(arg8[1]))
...
if ((result:1.b & 0x41) != 0)
    ...
    if (p_1)
        ...
        var_1d8.d = (*(*arg13 + 8))(0, 0)
        double var_208_1
        var_208_1.d = (*(*arg13 + 0x1c))()
        int32_t eax_8 = (*(*arg13 + 0x10))() - 1
        double var_290_1
        var_290_1.d = (*(*arg13 + 0x14))() - 1
        float var_26c_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_26c) / fconvert.t(arg7[3]))))
        float var_268_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_268) / fconvert.t(arg9[3]))))
        float var_278_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_278) / fconvert.t(arg11[3]))))
        float var_29c_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_29c) / fconvert.t(arg7[3]))))
        float var_2a4_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_2a4) / fconvert.t(arg9[3]))))
        float var_2b0_2 =
            fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_2b0) / fconvert.t(arg11[3]))))
        arg7[3]
        long double x87_r6_7 = float.t(1)
        float var_2b0_6 = fconvert.s(fconvert.t(fconvert.s(x87_r6_7 / fconvert.t(arg9[3]))))
        float var_2b0_8 = fconvert.s(fconvert.t(fconvert.s(x87_r6_7 / fconvert.t(arg11[3]))))
        ...
        char* esi_3 = (*(*arg5 + 8))(var_274_1, esi_2)
        int32_t j_2 = j_3
                ...
                if (j_2 s> 0)
                    ...
                    do
                        if (not(xmm0_25 f< 0) && not(xmm1_12 f< 0) && not(xmm3_3 f< 0)
                            ...
                            char* ecx_10 = (int.d(__minss_xmmss_memss(
                                __maxss_xmmss_memss(
                                    (xmm2_9 * var_29c_2 + xmm0_25 * var_2a4_2 + xmm1_12 * var_2b0_2)
                                        * var_260_1, 
                                    0), 
                                xmm0_22) f* xmm0_20) s>> 7) * var_208_1.d + var_1d8.d + (int.d(
                                __minss_xmmss_memss(
                                __maxss_xmmss_memss(
                            ...
                            var_218.d = 0
                            char ebx_7 =
                                (((zx.d(*ecx_10) - zx.d(edx_10.b)) * arg4) s>> 8).b + edx_10.b
                            edx_10.b = esi_3[1]
                            *esi_3 = ebx_7
                            xmm5_3 = var_2b0_16
                            xmm6 = var_2a4_3

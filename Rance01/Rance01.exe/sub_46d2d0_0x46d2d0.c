...
float var_20 = fconvert.s(fconvert.t(edx_1[1]))
...
double var_64 = fconvert.d(x87_r3_2)
...
float var_3c = fconvert.s(x87_r1_6 - fconvert.t(var_64))
long double x87_r2_15 = fconvert.t(var_1c)
long double x87_r2_17 = fconvert.t(arg7)
float var_e4 = fconvert.s(fconvert.t(var_64) - x87_r2_17)
var_64.d = fconvert.s(x87_r7_14 - fconvert.t(fconvert.d(x87_r2_15)))
var_64:4.d = fconvert.s(fconvert.t(fconvert.d(x87_r2_17)) - fconvert.t(var_c4))
float var_5c = fconvert.s(x87_r2_15 * fconvert.t(arg10) - x87_r7_14 * fconvert.t(arg7))
...
long double x87_r2_24 = fconvert.t(var_64:4.d)
long double x87_r1_17 = fconvert.t(var_64.d)
...
if ((result:1.b & 0x41) != 0)
    long double x87_r0_5 =
        fconvert.t(fconvert.s(x87_r3_2 * x87_r1_17 + x87_r5 * x87_r2_24 + fconvert.t(var_5c)))
    x87_r0_5 - x87_r1_20
    ...
    if (p_1)
        ...
        float var_84_1 = fconvert.s(fconvert.t(fconvert.s(x87_r5 - x87_r2_5)) * x87_r1_22)
        float var_80_1 = fconvert.s(fconvert.t(var_3c) * x87_r1_22)
        float var_78_1 = fconvert.s(x87_r3_8 * x87_r1_22)
        float var_74_1 = fconvert.s(x87_r5_2 * x87_r1_22)
        long double x87_r4_9 = float.t(1)
        long double x87_r4_10 = fconvert.t(fconvert.s(x87_r4_9 / x87_r4_9))
        float var_40_1 = fconvert.s(fconvert.t(fconvert.s(x87_r2_15 - x87_r5)) * x87_r4_10)
        float var_3c_1 = fconvert.s(fconvert.t(var_e4) * x87_r4_10)
        float var_34_1 = fconvert.s(x87_r1_17 * x87_r4_10)
        float var_30_1 = fconvert.s(x87_r2_24 * x87_r4_10)
        ...
        long double x87_r5_15 = fconvert.t(var_20)
        ...
        int32_t var_5c_1 = ecx_11
        float var_6c_1 = fconvert.s(x87_r7_42 * fconvert.t(var_4c_1) + fconvert.t(fconvert.s(
            fconvert.t(fconvert.s(x87_r1 * x87_r5 - x87_r3_2 * x87_r7_14)) * x87_r1_22)))
        float var_1c_1 = fconvert.s(x87_r7_42 * fconvert.t(var_80_1) + fconvert.t(fconvert.s(
            fconvert.t(fconvert.s(x87_r2_5 * x87_r3_2 - x87_r1_6 * x87_r5)) * x87_r1_22)))
        float var_20_1 = fconvert.s(x87_r7_42 * fconvert.t(var_74_1)
            + fconvert.t(fconvert.s(x87_r1_22 * x87_r2_22)))
        float var_18_1 = fconvert.s(fconvert.t(var_3c_1) * x87_r7_42 + fconvert.t(fconvert.s(
            fconvert.t(fconvert.s(x87_r2_17 * x87_r5 - x87_r2_15 * x87_r3_2)) * x87_r4_10)))
        float var_c_2 = fconvert.s(x87_r7_42 * fconvert.t(var_30_1)
            + fconvert.t(fconvert.s(x87_r4_10 * fconvert.t(var_5c))))
        result = result_1
        long double x87_r7_46 = fconvert.t(fconvert.s(float.t(var_10_1)))
        
        if (result s> 0)
            float* var_24_3 = result
            float* i
            
            do
                float var_54_1 = fconvert.s(fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_40_1)))
                    + fconvert.t(var_18_1))
                float var_68_1 = fconvert.s(fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_34_1)))
                    + fconvert.t(var_c_2))
                long double x87_r7_58 = fconvert.t(fconvert.s(
                    fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_84_1)))
                    + fconvert.t(var_1c_1)))
                ...
                long double x87_r4_30 = fconvert.t(fconvert.s(
                    fconvert.t(fconvert.s(x87_r7_46 * fconvert.t(var_78_1)))
                    + fconvert.t(var_20_1)))
                ...
                if (edx_14 s> 0)
                    ...
                    while (true)
                        ...
                        long double x87_r3_26 = fconvert.t(var_68_1)
                        float var_44_2
                        float var_8_4
                        ...
                        if ((result:1.b & 0x41) == 0)
                            x87_r6_52 = x87_r3_26
                        label_46ddf2:
                            var_8_4 = fconvert.s(x87_r7_58 + fconvert.t(var_84_1))
                            var_44_2 = fconvert.s(x87_r6_52 + fconvert.t(var_78_1))
                            var_54_1 = fconvert.s(x87_r4_36 + fconvert.t(var_40_1))
                            var_68_1 = fconvert.s(x87_r5_24 + fconvert.t(var_34_1))
                            ...
                            int32_t var_8_2 = sub_70c710(x87_r3_30)
                            int32_t eax_30 = sub_70c710(x87_r2_38)
                            
                            if (var_8_2 s< 0)
                                var_8_2 = 0
                            else if (var_8_2 s> eax_8)
                                var_8_2 = eax_8
                            
                            if (eax_30 s>= 0)
                                int32_t ecx_13 = var_94_1:4.d
                            ...
                            x87_r7_60 = x87_r2_38
                            int24_t edx_16 =
                                (*(eax_30 * var_9c_1:4.d + var_c4:4.d + (var_8_2 << 2))).3
                            uint32_t ecx_15
                            ecx_15.b = *(zx.d(arg15:3.b)
                                + ((zx.d(edx_16.b) * zx.d(arg10:3.b)) s>> 8) + edi_1)
                            int24_t var_8_3
                            var_8_3:1.b = *(zx.d(arg9:3.b)
                                + ((zx.d(edx_16:1.b) * zx.d(arg7:3.b)) s>> 8) + edi_1)
                            int32_t edx_23
                            edx_23.b = *(zx.d(arg8:3.b)
                                + ((zx.d(edx_16:2.b) * zx.d(arg6:3.b)) s>> 8) + edi_1)
                            result.b = *esi_5
                            var_8_3:2.b = edx_23.b
                            char ecx_19 =
                                (((zx.d(ecx_15.b) - zx.d(result.b)) * arg11) s>> 8).b + result.b
                            result.b = esi_5[1]
                            *esi_5 = ecx_19
                            char ecx_23 =
                            ...
                            esi_5[1] = ecx_23
                            var_8_4 = fconvert.s(x87_r7_58 + fconvert.t(var_84_1))
                            var_44_2 = fconvert.s(x87_r4_37 + fconvert.t(var_78_1))
                            var_54_1 = fconvert.s(x87_r5_24 + fconvert.t(var_40_1))
                            var_68_1 = fconvert.s(x87_r6_48 + fconvert.t(var_34_1))
                            esi_5[2] =
                                (((zx.d(var_8_3:2.b) - zx.d(result.b)) * arg11) s>> 8).b + result.b
                            var_10_2 = fconvert.s(x87_r3_30 + fconvert.t(var_b4_1))
                        esi_5 = &esi_5[4]
                        int32_t temp2_1 = var_28_3
                        var_28_3 -= 1
                ...
                i = var_24_3
                var_24_3 -= 1
                var_6c_1 = fconvert.s(fconvert.t(var_6c_1) + fconvert.t(var_4c_1))
                var_1c_1 = fconvert.s(fconvert.t(var_1c_1) + fconvert.t(var_80_1))
                var_20_1 = fconvert.s(fconvert.t(var_20_1) + fconvert.t(var_74_1))
                var_18_1 = fconvert.s(fconvert.t(var_3c_1) + fconvert.t(var_18_1))
                var_c_2 = fconvert.s(fconvert.t(var_30_1) + fconvert.t(var_c_2))
            while (i != 1)

...
*(((edx_1 u>> 0x1f) + edx_1) * 0xc4 + ecx_2 - 0xa0) = arg4
*(((edx_1 u>> 0x1f) + edx_1) * 0xc4 + ecx_2 - 0x9c) = arg5
*(((edx_1 u>> 0x1f) + edx_1) * 0xc4 + ecx_2 - 0x90) = arg6
*(((edx_1 u>> 0x1f) + edx_1) * 0xc4 + ecx_2 - 0x8c) = arg7
*(((edx_1 u>> 0x1f) + edx_1) * 0xc4 + ecx_2 - 0xc0) = 0x10
*(((edx_1 u>> 0x1f) + edx_1) * 0xc4 + ecx_2 - 0x88) = arg8
*(((edx_1 u>> 0x1f) + edx_1) * 0xc4 + ecx_2 - 0x84) = arg9
void* result
result.b = 1
fsbase->NtTib.ExceptionList = ExceptionList

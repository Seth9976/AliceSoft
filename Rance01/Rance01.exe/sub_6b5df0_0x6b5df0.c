...
if (data_798200 != 0)
    ...
    if (not(cond:0_1))
        ...
        *ecx = xmm0_4
        uint64_t xmm0_6[0x2] =
            __cmppd_xmmpd_mempd_immb(__andpd_xmmxuq_memxuq(xmm0_4, data_72a610), data_72a640, 4)
        ...
        sub_6b7e6f(&arg6, &arg8, &var_c, 0x3ef)
...
int32_t eax_4
int16_t x87control
eax_4, x87control = sub_6bf25a(arg5, 0, 0)
int32_t var_24 = 0xffff
int32_t var_28 = data_78cecc
int16_t x87control_1 = sub_6bf25a(x87control)
...
if (ecx_2.w != 0x7ff0)
    ...
    *arg8 = fconvert.d(st0_3)
    ...
    sub_6bf25a(x87control_1, eax_4.w, 0xffff)
else
    double* edi_2 = arg8
    *edi_2 = fconvert.d(fconvert.t(data_78ced8))
    var_20_1.q = fconvert.d(fconvert.t(arg6))
    int32_t eax_5 = sub_6be8d2(var_20_1, ecx_2)
    ...
    label_6be83d:
        ...
        *edi_2 = fconvert.d(x87_r7_14)
        ...
        int32_t var_34_1 = 8
        return sub_6bf095(8, 0x1c, (fconvert.d(fconvert.t(arg6))).d)

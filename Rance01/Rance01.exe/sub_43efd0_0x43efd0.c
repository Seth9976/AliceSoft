    ...
    do
        ...
        if (ecx_16 != 0)
            ...
            if (edx_8 s> 0)
                ...
                do
                    ...
                    char edx_13 = (((zx.d(*edi) - zx.d(*esi)) * ecx_25) s>> 8).b + *esi
                    esi += 4
                    *(esi - 4) = edx_13
                    uint32_t eax_22 = zx.d(*(esi - 2))
                    char edx_17 = (((zx.d(*(edi + 1)) - eax_21) * ecx_25) s>> 8).b + *(esi - 3)
                    edi += 4
                    *(esi - 3) = edx_17
                    ebx += 4
                    j = arg5
                    arg5 -= 1
                    *(esi - 2) += (((zx.d(*(edi - 2)) - eax_22) * ecx_25) s>> 8).b
                while (j != 1)
                result = arg10
        ...
        if (result s> 0)
            ...
            do
                ...
                int32_t xmm3_2[0x4] = xmm5_1 & xmm1_7
                int32_t xmm4_2[0x4] = xmm5_1 & _mm_srli_epi32(xmm1_7, 8)
                int32_t xmm0_4[0x4] = _mm_subs_epi16(xmm0_3, xmm4_2)
                int32_t xmm1_11[0x4] = _mm_subs_epi16(xmm5_1 & xmm6_1, xmm3_2)
                uint16_t xmm0_5[0x8] = _mm_mullo_epi16(xmm0_4, xmm2_6)
                int32_t xmm1_12[0x4] = _mm_mullo_epi16(xmm1_11, xmm2_6)
                int32_t xmm0_6[0x4] = _mm_srli_epi16(xmm0_5, 8)
                int32_t xmm1_13[0x4] = _mm_srli_epi16(xmm1_12, 8)
                int32_t xmm0_7[0x4] = _mm_adds_epi16(xmm0_6, xmm4_2)
                *esi = _mm_adds_epi16(xmm1_13, xmm3_2) | _mm_slli_epi32(xmm0_7, 8)
                esi += 0x10
                edi = &edi[1]
                ebx = &ebx[1]
                j_1 = result
        ...
        if (ecx_18 s> 0)
            ...
            do
                ...
                char edx_26 = (((zx.d(*edi) - zx.d(*esi)) * ecx_28) s>> 8).b + *esi
                esi += 4
                *(esi - 4) = edx_26
                result = zx.d(*(esi - 2))
                char edx_30 = (((zx.d(*(edi + 1)) - eax_26) * ecx_28) s>> 8).b + *(esi - 3)
                edi += 4
                *(esi - 3) = edx_30
                ebx += 4
                j_2 = arg3

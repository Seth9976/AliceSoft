...
if (esi_1 s<= 0x20)
    ...
    if (arg4[3].d - edx_1 s> 0x16)
        goto label_706115
    
    result = sub_6d3cb0(arg4)
    
    if (result == 0)
        edx_1 = &arg4[8]
        arg4[3].d = edx_1 + 0x1000
    label_706115:

...
int32_t edi
int32_t var_30 = edi
uint32_t CodePage = sub_6bdf85(arg1)
arg1 = CodePage
int32_t result
...
if (CodePage != 0)
    ...
    while (true)
        if (*(eax_4 + 0x78cad0) == CodePage)
            sub_6bc670(arg2 + 0x1c, 0, 0x101)
            void* ecx_3 = var_20_1 * 0x30
            void* var_24_1 = nullptr
            void* esi_2 = ecx_3 + 0x78cae0
            void* var_20_2 = esi_2
            ...
            *(arg2 + 4) = CodePage
            *(arg2 + 8) = 1
            *(arg2 + 0xc) = sub_6bdcbe(CodePage)
            void* eax_14 = arg2 + 0x10
            int16_t* ecx_4 = ecx_3 + 0x78cad4
            int32_t i_5 = 6
            int32_t i_1

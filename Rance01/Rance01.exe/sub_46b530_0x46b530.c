...
float var_14c = fconvert.s(fconvert.t(arg7[1]))
float var_194 = fconvert.s(fconvert.t(*arg9))
float var_1b0 = fconvert.s(fconvert.t(arg9[1]))
float var_190 = fconvert.s(fconvert.t(*arg2))
float var_1b4 = fconvert.s(fconvert.t(arg2[1]))
float var_1bc = fconvert.s(fconvert.t(*arg11))
float var_1b8 = fconvert.s(fconvert.t(arg11[1]))
float var_148 = fconvert.s(fconvert.t(*arg8))
float var_1a8 = fconvert.s(fconvert.t(arg8[1]))
float var_144 = fconvert.s(fconvert.t(*arg10))
float var_18c = fconvert.s(fconvert.t(arg10[1]))
...
if (p)
    ...
    void* esi_3 = (*(*arg5 + 8))(var_1ac_1, esi_2)
    int32_t j_2 = j_3
        ...
        do
            ...
            if (j_2 s> 0)
                ...
                do
                    ...
                    char ebx_8 = (((zx.d(*(eax_27 + (ecx_8 << 2))) - zx.d(edx_8.b)) * arg4) s>> 8).b
                        + edx_8.b
                    edx_8.b = *(esi_3 + 1)
                    *esi_3 = ebx_8
                    ...
                    char eax_32 = (((zx.d(*(ecx_9 + 1)) - zx.d(edx_8.b)) * arg4) s>> 8).b + edx_8.b
                    edx_8.b = *(esi_3 + 2)
                    *(esi_3 + 1) = eax_32

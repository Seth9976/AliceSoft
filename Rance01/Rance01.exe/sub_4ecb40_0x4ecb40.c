...
int32_t* ebx = *arg2
int32_t edi = arg2[1]
struct sealengine::CEmitterSize::VTable** esi = arg1

if (ebx == edi)
    *esi = &sealengine::CEmitterSize::`vftable'
...
while (true)
    ...
    if ((arg2:1.b & 0x41) != 0)
        ...
        if (p_1)
            ...
            sub_4be330(eax_3, esi, &edx_1[2], fconvert.s(fconvert.t(fconvert.s(x87_r7_3))))
            return 
    else
        ecx_1 = &ecx_1[5]

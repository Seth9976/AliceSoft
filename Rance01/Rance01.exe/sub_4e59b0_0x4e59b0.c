...
int32_t eax_5
int32_t edx
edx:eax_5 = muls.dp.d(0x66666667, *(arg2 + 0xf0) - *(arg2 + 0xec))
...
if ((edx_1 u>> 0x1f) + edx_1 s<= 0)
    ...
    char var_48 = 0
    sub_401270(&var_48, 0x13, 0x755964)
    int32_t var_4 = 0
    char* eax_8 = var_48.d
    char* edx_2 = eax_8
    ...
    int32_t eax_9
    int32_t edx_3
    edx_3:eax_9 = muls.dp.d(0x66666667, *(arg2 + 0xf0) - *(arg2 + 0xec))
    ...
    label_4e5bb2:
        ...
        while (true)
            if (sub_4e5ed0(arg1, *(arg2 + 0xec) + var_50_1).b == 0)
                result.b = 0
                break
            
            int32_t eax_15
            int32_t edx_5
            edx_5:eax_15 = muls.dp.d(0x66666667, *(arg2 + 0xf0) - *(arg2 + 0xec))
            ...
            int32_t eax_18
            int32_t edx_10
            edx_10:eax_18 = muls.dp.d(0x66666667, *(arg2 + 0xf0) - *(arg2 + 0xec))

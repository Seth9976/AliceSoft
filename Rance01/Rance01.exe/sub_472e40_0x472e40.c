...
float var_8 = fconvert.s(fconvert.t(*edx_2))
float* edx_3 = arg10
float var_1c = fconvert.s(fconvert.t(edx_2[1]))
float var_c = fconvert.s(fconvert.t(*edx_3))
float var_14 = fconvert.s(fconvert.t(edx_3[1]))
...
long double x87_r2 = fconvert.t(var_8)
...
if (p)
    ...
    float var_40_1 = fconvert.s(x87_r1_13 * x87_r3_7)
    float var_3c_1 = fconvert.s(x87_r5_2 * x87_r3_7)
    int32_t eax_3 = (*(*arg13 + 8))(0, 0)
    int32_t eax_5 = (*(*arg13 + 0x1c))()
    float eax_8 = (*(*arg13 + 0x10))() - 1
    int32_t eax_10 = (*(*arg13 + 0x14))()
    float var_48_1 = fconvert.s(fconvert.t(var_28) / fconvert.t(*(arg6 i+ 0xc)))
    float var_a8_1 = fconvert.s(fconvert.t(arg9) / fconvert.t(*(arg8 i+ 0xc)))
    float var_6c_1 = fconvert.s(fconvert.t(var_24) / fconvert.t(*(arg10 + 0xc)))
    float var_7c_1 = fconvert.s(fconvert.t(var_44) / fconvert.t(*(arg6 i+ 0xc)))
    float var_c4_1 = fconvert.s(fconvert.t(var_18) / fconvert.t(*(arg8 i+ 0xc)))
    float var_a4_1 = fconvert.s(fconvert.t(var_20) / fconvert.t(*(arg10 + 0xc)))
    *(arg6 i+ 0xc)
    long double x87_r6_12 = float.t(1)
    float var_90_1 = fconvert.s(x87_r6_12 / fconvert.t(*(arg8 i+ 0xc)))
    float var_a0_1 = fconvert.s(x87_r6_12 / fconvert.t(*(arg10 + 0xc)))
    long double x87_r7_39 = fconvert.t(arg11)
    long double x87_r6_16 = fconvert.t(var_8)
    x87_r6_16 - x87_r7_39
    int32_t eax_12
    ...
    float var_c_1 = fconvert.s(x87_r7_54 * fconvert.t(var_30_1) + fconvert.t(fconvert.s(
        fconvert.t(fconvert.s(x87_r2_5 * x87_r4_2 - x87_r1_5 * x87_r5)) * x87_r3_7)))
    float var_8_1 =
        fconvert.s(x87_r7_54 * fconvert.t(var_3c_1) + fconvert.t(fconvert.s(x87_r3_7 * x87_r2_21)))
    ...
    if (i_2 s> 0)
        ...
        do
            arg9 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_5c_1)))
                + fconvert.t(var_10_1))
            float var_4_2 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_34_1)))
                + fconvert.t(var_c_1))
            float var_14_1 = fconvert.s(fconvert.t(fconvert.s(x87_r7_58 * fconvert.t(var_40_1)))
                + fconvert.t(var_8_1))
            
            if (j_2 s> 0)
                double var_78
                var_78:4.d = zx.d(arg11:3.b)
                double var_88
                var_88:4.d = zx.d(arg16:3.b)
                double var_50_1
                ...
                do
                    ...
                    long double x87_r3_30 = fconvert.t(var_14_1)
                    long double x87_r2_33 = float.t(1)
                    long double x87_r2_38 = fconvert.t(fconvert.s(x87_r2_33 / x87_r2_33))
                    arg9 = sub_70c710(fconvert.t(fconvert.s((x87_r6_42 * fconvert.t(var_a8_1)
                        + x87_r4_20 * fconvert.t(var_48_1) + x87_r3_30 * fconvert.t(var_6c_1))
                        * x87_r2_38)))
                    int32_t eax_33 = sub_70c710(fconvert.t(fconvert.s(x87_r2_38 * (
                        x87_r6_42 * fconvert.t(var_c4_1) + x87_r4_20 * fconvert.t(var_7c_1)
                        + x87_r3_30 * fconvert.t(var_a4_1)))))
                    
                    if (arg9 s< 0)
                        arg9 = 0f
                    else if (arg9 s> eax_8)
                        arg9 = eax_8
                    ...
                    float edx_23 = *(eax_33 * eax_5 + eax_3 + (arg9 << 2))
                    esi_4 += 4
                    float ecx_13
                    ecx_13.b = *(((zx.d(edx_23.b) * zx.d(arg6:3.b)) s>> 8) + zx.d(arg8:3.b) + edi)
                    arg9:1.b = (((zx.d(edx_23:1.b) * zx.d(arg10:3.b)) s>> 8) + var_78:4.d)[edi]
                    arg9:2.b = (((zx.d(edx_23:2.b) * var_88:4.d) s>> 8) + var_50_1:4.d)[edi]
                    char eax_41 = *(esi_4 - 4)
                    char ecx_17 = (((zx.d(ecx_13.b) - zx.d(eax_41)) * arg12) s>> 8).b + eax_41
                    eax_41 = *(esi_4 - 3)
                    *(esi_4 - 4) = ecx_17
                    char ecx_21 = (((zx.d(arg9:1.b) - zx.d(eax_41)) * arg12) s>> 8).b + eax_41
                    eax_41 = *(esi_4 - 2)
                    *(esi_4 - 3) = ecx_21
                    uint32_t ecx_22 = zx.d(arg9:2.b)
                    arg9 = fconvert.s(x87_r4_20 + fconvert.t(var_5c_1))
                    var_4_2 = fconvert.s(x87_r6_42 + fconvert.t(var_34_1))
                    var_14_1 = fconvert.s(x87_r3_30 + fconvert.t(var_40_1))
                    j = j_1
                    j_1 -= 1
                    *(esi_4 - 2) = (((ecx_22 - zx.d(eax_41)) * arg12) s>> 8).b + eax_41
                while (j != 1)
                result = var_68:4.d
                j_2 = j_3

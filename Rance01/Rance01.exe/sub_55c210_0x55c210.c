...
int32_t (* var_c)(void* arg1) = sub_721ed0
TEB* fsbase
...
if (result u< arg2)
    ...
    sub_55c600(eax_8, result_1, *arg1, eax_8, result_1)
    int32_t var_8_2 = 0xffffffff
    int32_t* ebx_1 = *arg1
    int32_t eax_9
    int32_t edx_4
    edx_4:eax_9 = muls.dp.d(0x66666667, arg1[1] - ebx_1)
    int32_t edx_5 = edx_4 s>> 4
    
    if (ebx_1 != 0)
        int32_t var_2c_2 = arg2
        sub_539c30(ebx_1, arg1[1])
        int32_t var_38_1 = *arg1
        sub_6b4d5b()
    
    result = result_1
    arg1[2] = result + arg2 * 0x28
    arg1[1] = result + ((edx_5 u>> 0x1f) + edx_5) * 0x28
    *arg1 = result

...
int32_t var_74 = data_79b988
int32_t var_70 = data_79b98c
int32_t var_6c = data_79b990
int32_t var_68 = data_79b994
void var_64
...
if (zx.d(sub_6e0c40(&var_64, &var_74)) != 0)
    return (*(ebx + 0xac))(ebp, ebp + 0x100, ebp + 0x180, edi_1, esi)
...
if (zx.d(sub_6e0c70(&var_44, &data_79b8e0)) != 0)
    sub_6e86d0(ebp, ebp + 0x100, ebp + 0x180, edi_1, &var_44, esi)
...
return sub_6e86d0(ebp + 0x80, ebp + 0x108, ebp + 0x188, edi_1 + 0x18, &var_44, esi)

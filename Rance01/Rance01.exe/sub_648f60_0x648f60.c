...
sub_64af20(eax_7, arg3 - 0x28, arg2, esi, arg3 - 0x28, arg4)
int32_t* eax_8 = esi
void* i_1 = &esi[0xa]

if (arg2 u< esi)
    do
        int32_t ecx_4 = eax_8[-2]
        int32_t edx_4 = eax_8[8]
...
while (true)
    for (; i u< arg3; i += 0x28)
        int32_t ecx_8 = eax_8[8]
        int32_t esi_3 = *(i + 0x20)
    ...
    if (esi_10 u> arg2)
        ...
        do
            int32_t ecx_10 = *(ebx_3 + 0x20)
            int32_t esi_6 = eax_8[8]

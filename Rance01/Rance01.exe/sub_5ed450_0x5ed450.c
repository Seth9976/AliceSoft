...
if (i s> 1)
    ...
    do
        float var_7c[0x1b]
        sub_5ec740(&edi_1[-2], &var_7c)
        int32_t var_4 = 0
        edi_1[-2] = fconvert.s(fconvert.t(*arg4))
        edi_1[-1] = fconvert.s(fconvert.t(arg4[1]))
        *edi_1 = arg4[2]
        edi_1[1] = arg4[3]
        ...
        int32_t eax_16
        int32_t edx_3
        edx_3:eax_16 = muls.dp.d(0x4bda12f7, edi_1 + 0xfffffff8 - arg4)
        int32_t eax_19 = (edi_1 + 0xfffffff8 - arg4) s/ 0x6c
        sub_5ed8f0(eax_19, edx_3 s>> 5, 0, arg4, eax_19, &var_7c)

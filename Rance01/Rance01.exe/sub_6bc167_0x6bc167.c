...
if (arg5 != 1)
    ...
    if ((not(cond:1_1) && mods.dp.d(edx_18:eax_43, 0x64) != 0)
        ...
        esi_4 = (&data_78d13c)[arg1]
    else
        esi_4 = *((arg1 << 2) + &data_78d170)
    ...
    if ((not(cond:2_1) && mods.dp.d(edx:eax_5, 0x64) != 0) || mods.dp.d(edx_2:eax_8, 0x190) == 0)
        eax_11 = arg1 << 2
        esi_1 = *(eax_11 + &data_78d13c)
    else
        eax_11 = arg1 << 2
        esi_1 = *(eax_11 + &data_78d170)
    ...
    if (arg7 == 5)
        ...
        if ((eax_1 == 0 && mods.dp.d(edx_14:eax_31, 0x64) != 0)
            ...
            result = *(eax_11 + &data_78d140)
        else
            result = *(eax_11 + &data_78d174)
...
if (arg4 != 1)
    ...
    result = var_8 * 0x3e8
    int32_t temp4_1 = data_78c4c4
    data_78c4c4 += result
    
    if (temp4_1 + result s>= 0)
        result = 0x5265c00
        
        if (data_78c4c4 s>= 0x5265c00)
            data_78c4c4 -= 0x5265c00
            data_78c4c0 += 1
    else
        data_78c4c4 += 0x5265c00
        data_78c4c0 -= 1

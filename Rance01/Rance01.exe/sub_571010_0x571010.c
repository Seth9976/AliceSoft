...
if (cond:0)
    ...
    int32_t var_50_3 = eax_1
    
    if (eax_1 s<= eax_2)
        var_50_3 = eax_2
    
    if (eax_2 s<= 0 || eax_2 s<= eax_1)
        var_88:4.d = 0
        int32_t var_44_2 = *arg1[1]
        ...
        void* var_30
        (*(var_30 + 0x60))(arg2, 0)
        int32_t* eax_53 = &arg1[0x12]
        
        if (eax_1 s<= 0)
            eax_53 = &arg1[2]
        
        sub_571270(arg2, eax_53, arg1)
        int32_t eax_54
        eax_54.b = 1
        return eax_54
    
    var_88:4.d = 0
    int32_t var_48_1 = *arg1[1]
    ...
    if (eax_1 s<= 0)
        var_88.d = divs.dp.d(sx.q(arg1[0xf]), ecx_6)
        *arg1
        eax = (*(**arg1 + 8))(divs.dp.d(sx.q(arg1[0xe]), ecx_6), var_88)
        esp = &var_88:4
        edi_5 = eax
        ...
        if (edi_5 != 0)
            ...
            var_88.d = zx.d(*(arg3 + 0xa))
            int32_t* var_4c_5 = eax_36
            int32_t var_50_5 = *eax_36
        ...
        var_88.d = divs.dp.d(sx.q(arg1[0x1d]), ecx_6)
        *arg1
        eax = (*(**arg1 + 8))(divs.dp.d(sx.q(arg1[0x1c]), ecx_6), var_88)
        esp = &var_88:4
        edi_5 = eax
        ...
        if (edi_5 != 0)
            ...
            var_88.d = zx.d(*(arg3 + 0xa))
            int32_t var_54
            int32_t var_4c_4 = var_54 - var_50_3
            int32_t* eax_19 = arg1[1]
            int32_t* var_50_4 = eax_19
            int32_t var_54_1 = *eax_19
            var_88.d = (*(*edi_5 + 0x14))(zx.d(*(arg3 + 8)), zx.d(*(arg3 + 9)), var_88)
            var_88.d = (*(*edi_5 + 0x10))(var_88)
            int32_t var_8c_5 = 0
            int32_t var_90_4 = 0

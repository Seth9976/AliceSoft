...
if (GetCPInfo(*(arg1 + 4), &cPInfo) == 0)
    ...
    if (i_1.b != 0)
        ...
        do
            ...
            if (ecx_1 u<= i_1)
                sub_6bc670(&__saved_ebp + ecx_1 - 0x104, 0x20, i_1 - ecx_1 + 1)
    ...
    sub_6c2f72(nullptr, 1, &var_108, 0x100, &var_508, *(arg1 + 4), *(arg1 + 0xc))
    char var_208[0x100]
    sub_6c0cd3(nullptr, *(arg1 + 0xc), 0x100, &var_108, 0x100, &var_208, 0x100, *(arg1 + 4), 0)
    char var_308[0x100]
    sub_6c0cd3(nullptr, *(arg1 + 0xc), 0x200, &var_108, 0x100, &var_308, 0x100, *(arg1 + 4), 0)

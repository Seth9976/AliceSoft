...
if (*(arg1 + 0x84) == 0)
    ...
    *(arg1 + 0x84) = eax_6
    ...
    int32_t var_1c_1 = 0
    char var_2c = 0
    sub_401270(&var_2c, 0x1e, "DPGraphicEngineMainSplitWindow")
    int32_t var_4_2 = 1
    sub_658360(&var_2c, *(arg1 + 0x84), arg2, *(arg1 + 0x18), *(arg1 + 0x60), *(arg1 + 0x64), 
        *(arg1 + 0x68), *(arg1 + 0x7c))
...
if (result != 0 && *(arg1 + 0x88) != 0)
    sub_658d70(*(arg1 + 0x84), result, 0, 0)
    sub_658d70(*(arg1 + 0x84), *(arg1 + 0x88), 1, 0)
    result.b = 1
else
    result.b = 0

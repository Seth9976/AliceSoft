...
if (ebx_2 != 0xffffc001)
    ...
    *(edi_4 + 4) = esi_1[1]
    ...
    int32_t eax_19 = data_78d290
    
    if (ebx_2 s< eax_19 - data_78d294)
        var_14 = 0
        ...
        *edi_17 = 0
        ...
        int32_t ecx_34 = data_78d298
        
        if (ebx_2 s< data_78d28c)
            ebx_3 = ebx_2 + data_78d2a0
            var_14 &= 0x7fffffff
            int32_t eax_44
            int32_t edx_48
...
int32_t ecx_54 = data_78d29c
int32_t ebx_14 =
    ebx_3 << (0x1f - (data_78d298).b) | (sbb.d(ecx_51, ecx_51, ecx_2 != 0) & 0x80000000) | var_14

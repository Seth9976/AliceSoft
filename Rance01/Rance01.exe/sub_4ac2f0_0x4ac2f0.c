...
float var_c
float var_8
sub_4ac3f0(arg1, &var_4, &var_10, &var_c, &var_8)
...
if (p_3)
    eax_11, edx_2 = sub_70c710(x87_r7)
else
    int32_t eax_10
    eax_10, edx_2 = sub_70c710(x87_r7)
    eax_11 = eax_10 - 1
...
*(arg1 + 0x34) = edi_4 + 1
sub_4add30((eax_11 - ebp + 1) * (edi_4 + 1), edx_2, edi_4 + 1, arg1 + 0x14)
int32_t eax_15
int80_t result
result, eax_15 = sub_4ac4a0(arg1)
eax_15.b = 1
return result

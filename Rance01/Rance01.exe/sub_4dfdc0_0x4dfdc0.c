...
int32_t (* var_8)(void* arg1) = sub_722650
TEB* fsbase
...
if (result != 0)
    if (sub_51bea0() == 0)
        ...
        if (result == 0)
            ...
            if (sub_51bc80(&(*U"=,{,},}=,{,},}=,{,},}=,{,,,,}=,{,},}==,=,===")[0x12], arg1) != 0)
            label_4dffe5:
                long double x87_r7_1 = fconvert.t(var_38)
                float var_30_1 = fconvert.s(x87_r7_1)
                struct sealengine::CEmitterSize::VTable* const var_34_1 =
                ...
                struct sealengine::CEmitterSize::VTable* const var_24_1 =
                    &sealengine::CEmitterSize::`vftable'
                var_1c_1.b = 0
                var_4_8.b = 5
                sub_4e9230(&var_2c, arg2 + 0xfc)
                result = 1
            else
                sub_402be0(&var_2c, &(*U"=,{,},}=,{,},}=,{,},}=,{,,,,}=,{,},}==,=,===")[0x13])
                int32_t var_4_4 = 2

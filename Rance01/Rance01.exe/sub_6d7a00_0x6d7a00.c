    ...
    do
        ...
        if (arg3 s> 0)
            ...
            do
                ...
                edi_1 += 3
                (*result_1)[esi_3] = ((ebx_2 * 0x4d + ebp_2 * 0x96 + ecx_2 * 0x1d - 0x7f80) s>> 8).w
                (*result_1)[esi_3 + 0x80] =
...
if (i_1 s< 8)
    ...
    do
        int16_t edi_8 = *(ecx_5 + 0x1fc)
        int16_t esi_7 = *(ecx_5 - 2)
        *ecx_5 = *(ecx_5 - 0x20)
        int16_t ebp_4 = *(ecx_5 + 0xfe)
...
for (int32_t i_2 = 0; i_2 s< 0x80; i_2 += 0x10)
    ...
    do
        *edi_10 = *esi_9
        ...
        esi_9 += 2
        edi_10[0x40] = eax_16
        edi_10[0x80] = ((sx.d(*(j + 0x100)) + sx.d(*(j + 0x102)) + 1) s>> 1).w

...
if (p)
    ...
    if (i_2 s> 0)
        ...
        do
            ...
            float xmm1_7 = xmm0_19 * var_160 + xmm2_2 * var_164 + xmm3_3 * var_15c
            float xmm0_22 = xmm0_19 * var_1b4 + xmm2_2 * var_174 + xmm3_3 * var_1d8
                        ...
                        _mm_packus_epi16(
                            _mm_srli_epi16(
                                __pmullw_xmmdq_memdq(
                                    _mm_unpacklo_epi8(
                                        zx.o(*(edi_14 + (int.d(__minss_xmmss_memss(
                                            _mm_max_ss(xmm1_7, 0), xmm0_13)) << 2))), 
                                        0), 
                                    xmm0_12), 
                                8), 
                            zx.o(0)), 
            ...
            xmm1_3 = var_130 + fconvert.s(fconvert.t(var_14c_1))

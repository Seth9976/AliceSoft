...
int32_t var_54 = data_79b9d8
int32_t var_50 = data_79b9dc
int32_t var_4c = data_79b9e0
int32_t var_48 = data_79b9e4
void var_44
...
if (zx.d(sub_6e0c40(&var_44, &var_54)) != 0)
    return (*(ebx + 0xe0))(ebp, ebp + 0x80, ebp + 0x100, ebp + 0x180, edi_1, esi)
...
uint32_t eax_13 = zx.d(sub_6e0c70(&var_24, &data_79b8e0))

if (eax_13 == 0)
    return eax_13

return sub_6ec1e0(ebp, ebp + 0x80, ebp + 0x100, ebp + 0x180, edi_1, &var_24, esi)

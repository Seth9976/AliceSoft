...
void* result = sub_4ff4f0(eax, arg3)
int32_t esi_2 = 0x20
...
if (arg1 s> 0x20)
    do
        ...
        sub_4ff5d0(esi_2, ebp, ecx_5, arg3, var_28, nullptr, 0)
        int128_t** ecx_6 = *(arg4 + 0x10)
        int32_t* edx_4 = ecx_6[1]
        int32_t esi_3 = esi_2 * 2
        result = sub_4ff6e0(esi_3, edx_4, *ecx_6, edx_4, ebp, arg1, arg5)
        esi_2 = esi_3 * 2
    while (esi_2 s< arg1)

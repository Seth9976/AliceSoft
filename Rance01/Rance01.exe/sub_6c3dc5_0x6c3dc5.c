...
if (arg2 != 0 && arg3 != 0)
    ...
    int32_t ecx_3
    int32_t edx_1
    result, ecx_3, edx_1 = sub_6c52ae(edi_1, ecx_2, arg4, &var_30)
    ...
    if (result == 0)
        ...
        if (var_2c - 1 s< 0xfffffffc || var_2c - 1 s>= arg4)
            ...
            int32_t var_44_2 = 1
            result = sub_6c3643(arg2, edx_1, ecx_3, arg3, arg4, arg5, &var_30)
        else
            if (ecx_3.b != 0)
                int32_t eax_6
            ...
            result = sub_6c3c01(&var_30, edx_1, arg2, arg3, arg4, 1, arg6)
    else
        *arg2 = 0
else
    *__errno() = 0x16

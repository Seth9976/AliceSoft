    ...
    while (true)
        ...
        if (result_5 s< ecx_4)
            do
                ...
                int32_t esi_6 = *(ecx_2 + arg2 + 0x14) * *(ecx_2 + arg2 + 0x10)
                int32_t eax_8 = *(ecx_2 + arg2 - 0x78) * *(ecx_2 + arg2 - 0x7c)
                void* ecx_3 = ecx_2 + arg2
                
                if (esi_6 s< eax_8)
                    result_5 -= 1
                else if (esi_6 s<= eax_8 && *ecx_3 s< *(ecx_3 - 0x8c))
                    result_5 -= 1
        ...
        result = sub_643800(result_4, result_5, arg3, arg2)

...
int32_t (* var_8)(void* arg1) = sub_723075
TEB* fsbase
struct _EXCEPTION_REGISTRATION_RECORD* ExceptionList = fsbase->NtTib.ExceptionList
struct dpparts::CWindow::VTable** var_54
    ...
    do
        ...
        if (arg3 - 1 u> 0)
            ...
            do
                ...
                var_4.b = 1
                struct dpparts::CWindow::VTable** eax_9 = operator new(0x9c)
                var_54 = eax_9
                var_4.b = 2
                int32_t* var_30
                int32_t var_1c
                struct dpparts::CWindow::VTable** ebp_2
                ...
                if (eax_9 == 0)
                    ...
                    sub_65e270(ebp_1, eax_9, *(arg1 + 0x24), 0, 0, 0, eax_10, 0, 0)
                    eax_9[0x17] = 5
                    __builtin_memset(&eax_9[0x18], 0, 0x20)
                    eax_9[0x22].b = 0
                    eax_9[0x23] = 0
                    eax_9[0x24] = 0
                    eax_9[0x25] = 0
                    eax_9[0x26] = 0
                    *eax_9 = &dpparts::CSplitWindowBorderCrossTuning::`vftable'{for `dpparts::CSplitWindowBorder'}
                    ebp_2 = eax_9
                ...
                sub_65e420(ecx_3, ecx_3, eax_12, ebp_2, 0x54000000, ecx_3 * result_1, ecx_3 * i_1, 
                    *(arg1 + 0x20), nullptr, *(arg1 + 0x24))
                int32_t esi_2 = var_50
                ebp_2[0x24] = arg1 + 0x34
                ebp_2[0x23] = arg1 + 0x36
                ebp_2[0x25] = *(arg1 + 0x28)
                int32_t eax_15
                eax_15.b = *(arg1 + 0x56)
                char edx_9 = *(arg1 + 0x54)
                *(ebp_2 + 0x99) = *(arg1 + 0x55)
                *(ebp_2 + 0x9a) = eax_15.b
                struct dpparts::CWindow::VTable*** eax_16 = var_4c_1
                ebp_2[0x26].b = edx_9
        ...
        if (&var_50 u>= eax_23 || edx_19 u> &var_50)
            int32_t ecx_19 = *(arg1 + 0xb0)
            
            if (eax_23 == ecx_19)
                int32_t edx_21 = *(arg1 + 0xa8)
        ...
        label_658cde:
            ...
            if (eax_23 == ecx_14)
                ...
                if (eax_25 + 1 u> ecx_16)
                    ...
                    struct dpparts::CWindow::VTable** ecx_17
                    ...
                    struct dpparts::CWindow::VTable** eax_29 = var_54
                    
                    if (ecx_17 u< eax_29)
                        ecx_17 = eax_29
                    
                    sub_6630b0(arg1 + 0xa8, ecx_17)
        ...
        label_658c72:
            ...
            if (eax_33 != 0)
                sub_6b05e0(eax_33, ((&var_50 - edx_19) & 0xfffffff0) + *(arg1 + 0xa8))
        *(arg1 + 0xac) += 0x10
        int32_t var_4_1 = 0xffffffff
        int32_t eax_34 = var_50
        
        if (eax_34 != 0)
            int32_t var_6c_8 = eax_34
            sub_6b4d5b()

...
if (result u> arg1)
    return sub_617cf0(arg4, &var_4, ebp + arg1 * 0x14, ebx)

if (result u< arg1)
    sub_617d60(arg4, arg1 - result)
    struct dpanalysis::SVarSourceList::VTable** ebx_1 = arg4[1]
    ...
    sub_617f50(eax_7, edx_6, arg1 - edx_6, ebx_1)

...
int32_t var_1c = 0
char var_2c = 0
sub_401270(&var_2c, 0x12, "DPSpriteListWindow")
int32_t var_4 = 0

if (*(arg1 + 0xa0) == 0)
    struct dpparts::CWindow::VTable** eax_6 = operator new(0x31c)
    ...
    if (eax_6 == 0)
        ...
        eax_12 = sub_644dc0(eax_8, eax_9, eax_6, *(arg1 + 0x18), var_3c, eax_10, eax_7)
    
    var_4.b = 0
    *(arg1 + 0xa0) = eax_12
    eax_12[0x63] = arg1 + 0x84
    *(*(arg1 + 0xa0) + 0x188) = *(arg1 + 0x98)
    sub_6464f0(*(arg1 + 0xa0))

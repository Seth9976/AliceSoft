...
while (true)
    ...
    double xmm2_1[0x2] = data_75bf50
    double xmm4_1[0x2] = data_75bf60
    uint64_t xmm6_1[0x2] = data_75bf70
    uint64_t xmm0_2[0x2] = _mm_or_pd(_mm_and_pd(xmm0, data_75bf40), data_75bfb0)
    eax_2 = _mm_extract_epi16(_mm_add_pd(xmm4_1, xmm0_2), 0) & 0x7f0
    double xmm4_3[0x2] = *(eax_2 + 0x75c450)
    xmm7_1 = (*(eax_2 + 0x75c040)).q
    ...
    double xmm0_11 = arg2
    double xmm1_10[0x2] = _mm_cmpeq_sd((data_75bfc0).q, xmm0_11, 0)
    int32_t edx_2
    ...
    label_70d9dd:
        var_c = xmm1_10
        sub_6b7e6f(&arg2, &arg2, &var_c, edx_2)
    ...
    if ((ecx_1 & 0xfff) != 0)
        if ((ecx_1 & 0xfff) - 1 u> 0x7fe)
            ...
            xmm1_10 = data_75bf40
            uint64_t xmm2_6[0x2] = data_75bfb0
...
double xmm2_2[0x2] = data_75c010
double xmm1_3[0x2] = _mm_mul_pd(data_75c000, xmm0_5)
double xmm3_3 = _mm_mul_pd(xmm0_5, xmm0_5)
double xmm1_4[0x2] = _mm_add_pd(xmm1_3, xmm2_2)
double xmm2_3[0x2] = data_75c020
double xmm6_7[0x2] = _mm_mul_pd(xmm6_6, data_75bf80)
uint64_t xmm4_5[0x2] = _mm_and_pd(xmm0_4, *(edx_1 + 0x75bf90))
...
double xmm2_5[0x2] = _mm_mul_pd(data_75c030, xmm0_5)

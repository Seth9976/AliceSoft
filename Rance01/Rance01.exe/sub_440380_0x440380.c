    ...
    do
        ...
        if (ecx_16 != 0)
            ...
            if (j_6 s> 0)
                ...
                do
                    ...
                    char edx_12 = (((zx.d(*edi_1) - zx.d(*esi_1)) * ecx_25) s>> 8).b + *esi_1
                    esi_1 += 4
                    *(esi_1 - 4) = edx_12
                    uint32_t eax_22 = zx.d(*(esi_1 - 2))
                    char edx_16 = (((zx.d(*(edi_1 + 1)) - eax_21) * ecx_25) s>> 8).b + *(esi_1 - 3)
                    edi_1 += 4
                    *(esi_1 - 3) = edx_16
                    ebx_1 = &(*ebx_1)[1]
                    j = j_3
                    j_3 -= 1
                    *(esi_1 - 2) += (((zx.d(*(edi_1 - 2)) - eax_22) * ecx_25) s>> 8).b
                while (j != 1)
                result = result_1
        ...
        if (result s> 0)
            ...
            do
                ...
                uint32_t xmm1_8[0x4] = _mm_srli_epi32(
                    __pmullw_xmmdq_memdq(
                        ...
                        xmm0_3), 
                    8)
                int32_t xmm2_6[0x4] = _mm_slli_epi32(xmm1_8, 0x10) | xmm1_8
                uint32_t xmm1_9[0x4] = *esi_1
                int32_t xmm3_2[0x4] = xmm5_1 & xmm1_9
                int32_t xmm4_2[0x4] = xmm5_1 & _mm_srli_epi32(xmm1_9, 8)
                int32_t xmm0_6[0x4] = _mm_subs_epi16(xmm0_5, xmm4_2)
                int32_t xmm1_13[0x4] = _mm_subs_epi16(xmm5_1 & xmm6_1, xmm3_2)
                uint16_t xmm0_7[0x8] = _mm_mullo_epi16(xmm0_6, xmm2_6)
                int32_t xmm1_14[0x4] = _mm_mullo_epi16(xmm1_13, xmm2_6)
                int32_t xmm0_8[0x4] = _mm_srli_epi16(xmm0_7, 8)
                int32_t xmm1_15[0x4] = _mm_srli_epi16(xmm1_14, 8)
                int32_t xmm0_9[0x4] = _mm_adds_epi16(xmm0_8, xmm4_2)
                *esi_1 = _mm_adds_epi16(xmm1_15, xmm3_2) | _mm_slli_epi32(xmm0_9, 8)
                esi_1 = &esi_1[1]
                edi_1 = &edi_1[1]
                ebx_1 = &ebx_1[1]
                j_1 = result
        ...
        if (j_5 s> 0)
            ...
            do
                ...
                char edx_25 = (((zx.d(*edi_1) - zx.d(*esi_1)) * ecx_29) s>> 8).b + *esi_1
                esi_1 += 4
                *(esi_1 - 4) = edx_25
                result = zx.d(*(esi_1 - 2))
                char edx_29 = (((zx.d(*(edi_1 + 1)) - eax_26) * ecx_29) s>> 8).b + *(esi_1 - 3)
                edi_1 += 4
                *(esi_1 - 3) = edx_29
                ebx_1 = &(*ebx_1)[1]
                j_2 = j_4
                j_4 -= 1
                *(esi_1 - 2) += (((zx.d(*(edi_1 - 2)) - result) * ecx_29) s>> 8).b
            while (j_2 != 1)

...
if (arg3 - 1 u<= 8)
    switch (arg3 + &jump_table_5e0a9c[2]:3)
        case &lookup_table_5e0aa8[3], &lookup_table_5e0aa8[4], &lookup_table_5e0aa8[5]
            int32_t eax_10
            int32_t edx
            edx:eax_10 = sx.q(var_4)
            return neg.d((eax_10 - edx) s>> 1) + arg2
        case &lookup_table_5e0aa8[6], &lookup_table_5e0aa8[7], &lookup_table_5e0aa8[8]

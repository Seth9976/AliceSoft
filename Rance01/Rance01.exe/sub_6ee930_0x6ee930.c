...
int32_t var_b4 = data_79b9f8
int32_t var_b0 = data_79b9fc
int32_t var_ac = data_79ba00
int32_t var_a8 = data_79ba04
void var_a4
...
if (zx.d(sub_6e0c40(&var_a4, &var_b4)) != 0)
    return (*(ebx + 0xe8))(ebp, ebp + 0x200, ebp + 0x280, ebp + 0x300, edi_1, esi)
...
if (zx.d(sub_6e0c70(&var_84, &data_79b8e0)) != 0)
    sub_6eda20(ebp, ebp + 0x200, ebp + 0x280, ebp + 0x300, edi_1, &var_84, esi)
...
if (zx.d(sub_6e0c70(&var_84, &data_79b8e0)) != 0)
    sub_6eda20(ebp + 0x80, ebp + 0x208, ebp + 0x288, ebp + 0x380, edi_1 + 0x20, &var_84, esi)
...
if (zx.d(sub_6e0c70(&var_84, &data_79b8e0)) != 0)
    sub_6eda20(ebp + 0x100, ebp + 0x240, ebp + 0x2c0, ebp + 0x400, edi_1 + (esi << 3), &var_84, esi)
...
int32_t eax_27 = zx.d(sub_6e0c70(&var_84, &data_79b8e0))

if (eax_27 == 0)
    return eax_27

return sub_6eda20(ebp + 0x180, ebp + 0x248, ebp + 0x2c8, ebp + 0x480, edi_1 + (esi << 3) + 0x20, 
    &var_84, esi)

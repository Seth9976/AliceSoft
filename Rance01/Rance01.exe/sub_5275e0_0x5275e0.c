...
if (arg1 s>= 0)
    ...
    if (arg1 s< (*(ecx_1 + 0x44) - *(ecx_1 + 0x40)) s>> 2)
        ...
        if (eax_2 != 0)
            ...
            float var_60 = fconvert.s(fconvert.t(eax_4[4]) * x87_r6 + fconvert.t(*eax_4)
                + fconvert.t(eax_4[8]) * x87_r6)
            float var_5c = fconvert.s(fconvert.t(eax_4[5]) * x87_r6 + fconvert.t(eax_4[1])
                + fconvert.t(eax_4[9]) * x87_r6)
            long double x87_r6_8 = fconvert.t(eax_4[6]) * x87_r6 + fconvert.t(eax_4[2])

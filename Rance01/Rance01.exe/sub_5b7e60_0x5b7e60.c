...
double var_c = fconvert.d(x87_r2)
int32_t edx_2 = eax[ebx * 0xe - 0xd]
...
if (ebx s>= 4)
    ...
    while (true)
        ...
        int32_t edx_5 = *(eax_1 + 0x34)
        long double x87_r2_4 =
            float.t(edi_1 + edx_3) * fconvert.t(*(arg3 + 0x454)) / float.t(edx_3 + 1) + x87_r7
        int32_t edi_5 = *(eax_1 + 0x84)
        int32_t edx_7 = *(eax_1 + 0x6c)
        long double x87_r2_11 =
            float.t(edi_3 + edx_5) * fconvert.t(*(arg3 + 0x454)) / float.t(edx_5 + 1) + x87_r7
        ...
        long double x87_r2_18 =
            float.t(edi_5 + edx_7) * fconvert.t(*(arg3 + 0x454)) / float.t(edx_7 + 1) + x87_r7
        ...
        int32_t edx_9 = *(eax_1 + 0xa4)
        eax_1 += 0xe0
        int32_t temp1_1 = esi_3
        esi_3 -= 1
        long double x87_r2_25 =
            float.t(edi_7 + edx_9) * fconvert.t(*(arg3 + 0x454)) / float.t(edx_9 + 1) + x87_r7
        ...
        x87_r2 = x87_r2_25 * float.t(edx_9) + float.t(edi_7) + fconvert.t(fconvert.d(
            x87_r2_18 * float.t(edx_7) + float.t(edi_5) + fconvert.t(fconvert.d(
            x87_r2_11 * float.t(edx_5) + float.t(edi_3) + fconvert.t(fconvert.d(
            x87_r2_4 * float.t(edx_3) + float.t(edi_1) + fconvert.t(var_c)))))))
        var_c = fconvert.d(x87_r2)
...
if (ebp s< ebx)
    void* eax_2 = &eax[ebp * 0xe + 8]
    int32_t i_1 = ebx - ebp
    int32_t i
    
    do
        int32_t esi_4 = *(eax_2 + 0x14)
        int32_t edx_13 = *(eax_2 - 4)
        eax_2 += 0x38
        i = i_1
        i_1 -= 1
        long double x87_r1_53 =
            float.t(esi_4 + edx_13) * fconvert.t(*(arg3 + 0x454)) / float.t(edx_13 + 1) + x87_r7
        double var_c_4 = fconvert.d(x87_r1_53)
        x87_r6 = x87_r6 + x87_r1_53 * float.t(*(eax_2 - 0x50)) + float.t(*(eax_2 - 0x38))
        x87_r5 = x87_r5 + float.t(*(eax_2 - 0x4c)) * fconvert.t(var_c_4) + float.t(*(eax_2 - 0x34))
        x87_r4 = x87_r4 + float.t(*(eax_2 - 0x48)) * fconvert.t(var_c_4) + float.t(*(eax_2 - 0x30))
        x87_r3 = x87_r3 + float.t(*(eax_2 - 0x40)) * fconvert.t(var_c_4) + float.t(*(eax_2 - 0x28))
        x87_r2 = x87_r2 + float.t(edx_13) * fconvert.t(var_c_4) + float.t(esi_4)
    while (i != 1)
    edx_2 = arg5
    x87_r1 = x87_r7
    x87_r7 = float.t(0)
...
long double st0
st0, x87control_1 = sub_70cb70(mxcsr, x87control, 
    fconvert.d(x87_r2_32 + x87_r7_1 * float.t(var_20) + fconvert.t(0.5)))
int32_t eax_6 = sub_70c710(st0)
*arg6 = eax_6
int32_t eax_7 = sub_70c710(sub_70cb70(mxcsr, x87control_1, 
    fconvert.d(float.t(arg5) * fconvert.t(fconvert.d(x87_r7_1)) + fconvert.t(var_14.q)
        + fconvert.t(0.5))))
*arg7 = eax_7

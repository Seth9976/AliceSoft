...
if (eax s>= 0)
    ...
    if (eax s< (*(arg1 + 0xc) - ecx) s>> 2)
        ...
        if (arg3 - 1 u<= 8)
            switch (arg3 + &jump_table_5eae44[2]:3)
                case &lookup_table_5eae50[1], &lookup_table_5eae50[4], &lookup_table_5eae50[7]
                    int32_t eax_10
                    int32_t edx_4
                    edx_4:eax_10 = sx.q(var_8)
                    return neg.d((eax_10 - edx_4) s>> 1) + arg2
                case &lookup_table_5eae50[2], &lookup_table_5eae50[5], &lookup_table_5eae50[8]

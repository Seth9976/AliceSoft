...
if (*(arg1 + 8) != 0)
    ...
    if (arg3 == *eax)
        if (sub_405dd0(&arg3[3], &ebx[3]) == 0)
            *arg2 = *sub_4af5e0(arg1, &var_8, ebx)
            return arg2
        
        sub_4af740(arg3, arg1, arg2, 1, ebx)
        return arg2
    
    if (arg3 == eax)
        if (sub_405dd0(&ebx[3], eax[2] + 0xc) != 0)
            sub_4af740(*(*(arg1 + 4) + 8), arg1, arg2, 0, ebx)
            return arg2
    ...
    if (eax_12 != 0 && eax_15 != 0)
        ...
        if (*(eax_16[2] + 0x35) != 0)
            sub_4af740(eax_16, arg1, arg2, 0, ebx)
            return arg2
    ...
    if (*(arg3[2] + 0x35) != 0)
        sub_4af740(arg3, arg1, arg2, 0, var_18)
        return arg2
else
    var_18 = ebx

sub_4af740(eax, arg1, arg2, 1, var_18)
return arg2

...
sub_6418f0(arg4, edx_3, arg2, esi_3, arg3 - 0x8c, arg4)
...
while (true)
    ...
    if (esi_13 u> arg2)
        ...
        do
            int32_t ecx_11 = *(ebx_2 + 0x20)
            int32_t esi_9 = eax_7[8]

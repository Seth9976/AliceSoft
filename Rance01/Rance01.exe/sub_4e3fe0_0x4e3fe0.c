...
if (var_51 != 0)
    ...
    if (sub_51b970(&var_48, &var_4c).b != 0)
        if (sub_402680(0x7555c0, &var_48).b == 0)
            int32_t* edi_2 = &var_48
            
            if (sub_402680(0x7555c8, edi_2).b != 0)
                *(arg2 + 0x64) = 1
            else if (sub_402680(0x7555d0, edi_2).b != 0)
                *(arg2 + 0x64) = 1
            else if (sub_402680(0x7555d4, edi_2).b != 0)
                *(arg2 + 0x64) = 2
            else if (sub_402680(0x7555e0, edi_2).b != 0)
                *(arg2 + 0x64) = 2
            else if (sub_402680(0x7555e4, edi_2) == 0)
                char* eax_8 = var_48.d

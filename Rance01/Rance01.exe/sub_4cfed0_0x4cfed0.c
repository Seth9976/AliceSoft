...
int32_t (* var_c)(void* arg1) = sub_717bf0
TEB* fsbase
...
if (result u< arg2)
    char* eax_6 = sub_4cffd0(arg2)
    int32_t var_8_1 = 0
    int32_t edx_4 = arg1[1]
    int32_t var_2c_1 = arg2
    sub_4d04f0(eax_6, edx_4, *arg1, edx_4, eax_6)
    ...
    if (ebx_1 != 0)
        ...
        sub_4d0240(ebx_1, arg1[1])
        int32_t var_38_1 = *arg1
        sub_6b4d5b()
    
    result = &eax_6[arg2 * 0x34]
    arg1[2] = result
    arg1[1] = ((edx_6 u>> 0x1f) + edx_6) * 0x34 + eax_6
    *arg1 = eax_6

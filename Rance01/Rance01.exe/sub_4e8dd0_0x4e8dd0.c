...
void* var_38 = nullptr
char var_48 = 0
sub_401270(&var_48, 0xd, 0x755d1c)
int32_t var_4 = 0
char* ecx = var_48.d
...
if (((*(arg2 + 0x138) - *(arg2 + 0x134)) & 0xfffffffc) s> 0)
    int32_t i
    ...
    do
        ...
        int32_t var_68_4 = *(*(arg2 + 0x134) + (i_1 << 2))
        int128_t* eax_11 = sub_4104a0("\t\t%d")
        int32_t var_4_4 = 2
        int32_t ecx_5 = *(eax_11 + 0x14)
        int32_t esi_7 = eax_11[1].d
        int128_t* edi_3
        ...
        void* var_68_5 = var_50
        sub_4102d0(var_50, *(arg1 + 8), eax_11, edi_3 + esi_7)
        ...
        i = i_1 + 1
        i_1 = i
    while (i s< (*(arg2 + 0x138) - *(arg2 + 0x134)) s>> 2)

int32_t var_18 = 0xf
int32_t var_1c = 0
char var_2c = 0
sub_401270(&var_2c, 2, 0x755d38)
int32_t var_4_6 = 3
...
void* var_68_7 = var_50
sub_4102d0(var_50, *(arg1 + 8), eax_14, ecx_10 + var_1c)

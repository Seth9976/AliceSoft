...
if (z)
    ...
    if ((arg1 & 0xfffff) != 0 || arg4 != 0)
        ...
        x87_r0_1 = data_75c8c0
        arg1 = 1
    
    if (data_797954 == 0)
        int32_t eax
        int80_t st0_4
        st0_4, eax = __startOneArgErrorHandling(arg1, 0x20, x87_r0_1, &data_796e60, var_4)
        return eax
else
    int16_t x87control
    int16_t x87status_1
    ...
    if (test_bit(arg1:1.b, 2))
        unimplemented  {fld st0, tword [0x75c8fa]}
        c1_1 = false
    ...
    if (data_797954 == 0)
        ...
        if (arg1.w != 0x27f)
            ...
            if (arg1.w != 0)
                ...
                if (arg1.w != 0)
                    int32_t eax_1 = __startOneArgErrorHandling(8, 0x20, st0_1, &data_796e60, var_4)
                    unimplemented  {call 0x70dfb7}
                    return eax_1

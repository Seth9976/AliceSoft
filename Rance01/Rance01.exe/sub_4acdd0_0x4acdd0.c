...
if (eax_3 - 1 s<= ecx)
    ...
    if (var_b8 s>= edx_1 && ebx s<= *(arg1 + 0x30) && eax_7 + 1 s>= *(arg1 + 0x2c))
        if (eax_3 - 1 s< edx_1)
            var_98 = edx_1
        ...
        if (i_2 != ecx_6)
            ...
            do
                int32_t* eax_19 = i_2[3]
                int32_t ebp_1 = 0
                int32_t* var_6c_1 = eax_19
                int32_t var_9c_2 = 0
                void* var_98_1 = &eax_19[7]
                ...
                while (true)
                    if (*var_98_1 == 0)
                        ...
                        float* edx_7 = &ebx_2[edx_6]
                        long double x87_r6_7 = fconvert.t(ebx_2[edx_6 + 2]) - fconvert.t(*ecx_8)
                        float* var_a8_2 = edx_7
                        long double x87_r4_2 = fconvert.t(*edx_7) - fconvert.t(*(ebx_2 + ebp_1))
                        ...
                        if (not(p_1))
                            ...
                            long double x87_r3_7 =
                                (fconvert.t(edi[2]) - fconvert.t(*ecx_8)) * x87_r6_7
                                + (fconvert.t(*edi) - fconvert.t(*(ebx_2 + ebp_1))) * x87_r4_2
                            ...
                            if ((eax_23:1.b & 1) != 0)
                                ...
                                if ((eax_23:1.b & 1) != 0)
                                    ...
                                    float var_94_1 = fconvert.s(x87_r4_4 * x87_r4_2
                                        + fconvert.t(*(ebx_2 + ebp_1)))
                                    float var_ac_3 =
                                        fconvert.s(x87_r4_4 * x87_r6_7 + fconvert.t(*ecx_8))
                                    long double x87_r4_9 = fconvert.t(var_94_1) - fconvert.t(*edi)
                                    long double x87_r3_13 =
                                        fconvert.t(var_ac_3) - fconvert.t(edi[2])
                                    long double x87_r4_12 = fconvert.t(fconvert.s(
                                        x87_r4_9 * x87_r4_9 + x87_r3_13 * x87_r3_13))
                                    ...
                                    if ((eax_23:1.b & 1) != 0)
                                        ...
                                        float var_1c = fconvert.s(fconvert.t(fconvert.s(x87_r6_7)))
                                        float var_18_1 = fconvert.s(x87_r7_6)
                                        float var_14_1 =
                                            fconvert.s(fconvert.t(fconvert.s(fneg(x87_r4_2))))
                                        float var_58
                                        sub_51e2a0(&var_1c, &var_58)
                                        long double x87_r6_11 = fconvert.t(arg3)
                                        edi = arg2
                                        float var_c0_2 = fconvert.s(fconvert.t(var_58) * x87_r6_11)
                                        float var_50
                                        var_b4 = fconvert.s(x87_r6_11 * fconvert.t(var_50))
                                        var_b4 =
                                            fconvert.s(fconvert.t(var_b4) + fconvert.t(var_ac_3))
                                        *arg2 = fconvert.s(fconvert.t(fconvert.s(
                                            fconvert.t(var_c0_2) + fconvert.t(var_94_1))))
                                        long double x87_r7_20 = fconvert.t(var_b4)
                                        float var_54
                                        *(arg2 + 4) = fconvert.s(fconvert.t(fconvert.s(
                                            fconvert.t(fconvert.s(fconvert.t(var_54) * x87_r6_11))
                                            + fconvert.t(0.0))))
                                        edx_7 = var_a8_2
                                        x87_r7_21 = float.t(0)
                                        *(arg2 + 8) = fconvert.s(x87_r7_20)
                                        ecx_8 = var_a0_1
                        
                        long double x87_r6_16 = fconvert.t(edi[2]) - fconvert.t(*ecx_8)
                        long double x87_r4_14 = fconvert.t(*edi) - fconvert.t(*(ebx_2 + ebp_1))
                        var_b4 = fconvert.s(x87_r6_16 * x87_r6_16 + x87_r4_14 * x87_r4_14)
                        ...
                        if ((eax_23:1.b & 1) != 0)
                            ...
                            float var_38_1 = fconvert.s(fconvert.t(fconvert.s(x87_r6_16)))
                            float var_28
                            sub_51e2a0(&var_40, &var_28)
                            long double x87_r6_18 = fconvert.t(arg3)
                            edi = arg2
                            var_b4 = fconvert.s(fconvert.t(var_28) * x87_r6_18)
                            float var_20
                            float var_ac_4 = fconvert.s(x87_r6_18 * fconvert.t(var_20))
                            ...
                            *arg2 = fconvert.s(fconvert.t(var_b4))
                            float var_24
                            *(arg2 + 4) = fconvert.s(fconvert.t(fconvert.s(
                                fconvert.t(fconvert.s(fconvert.t(var_24) * x87_r6_18))
                                + fconvert.t(0.0))))
                            edx_7 = var_a8_2
                            x87_r7_40 = float.t(0)
                            *(arg2 + 8) = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_ac_4)
                                + fconvert.t(var_a0_2))))
                        
                        long double x87_r6_23 = fconvert.t(edi[2]) - fconvert.t(edx_7[2])
                        long double x87_r4_18 = fconvert.t(*edi) - fconvert.t(*edx_7)
                        var_b4 = fconvert.s(x87_r6_23 * x87_r6_23 + x87_r4_18 * x87_r4_18)
                        ...
                        if ((eax_23:1.b & 1) != 0)
                            ...
                            var_b4 = fconvert.s(x87_r4_18)
                            float var_4c = fconvert.s(fconvert.t(var_b4))
                            float var_48_1 = fconvert.s(x87_r7_40)
                            float var_44_1 = fconvert.s(fconvert.t(fconvert.s(x87_r6_23)))
                            float var_34
                            ...
                            *(arg2 + 4) = fconvert.s(fconvert.t(fconvert.s(
                                ...
                                + fconvert.t(0.0))))
                            x87_r7_6 = float.t(0)
                            *(arg2 + 8) = fconvert.s(fconvert.t(fconvert.s(fconvert.t(var_a0_3)
                                + fconvert.t(var_ac_5))))

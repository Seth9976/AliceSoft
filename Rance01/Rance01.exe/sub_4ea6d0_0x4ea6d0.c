...
int32_t (* var_c)(void* arg1) = sub_7118a0
TEB* fsbase
...
int32_t eax_3
int32_t edx
edx:eax_3 = muls.dp.d(0x38e38e39, arg2[1] - *arg2)
...
if (edi_1 != neg.d(edx_1))
    if (edi_2 u> 0x71c71c7)
        sub_6b47bf("vector<T> too long")
        noreturn
    
    int32_t* eax_4 = sub_60de80(edi_2)
    arg1[2] = &eax_4[edi_2 * 9]
    int32_t var_8_1 = 0
    *arg1 = eax_4
    arg1[1] = eax_4
    ...
    arg1[1] = sub_4eb310(eax_4, arg1, ecx_5)

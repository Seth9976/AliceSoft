...
eax_8[3] = *(ebx_2 + 0x30)
eax_8[4] = ebx_2
int32_t eax_11 = vFunc_10()
int32_t ebp_2 = eax_6 - *(arg1 + 0xc)
void* ecx_5 = *(arg1 + 0x18)
int32_t eax = eax_11 - *(arg1 + 0x10)

if (*(ecx_5 + 0x10) != ebp_2 || *(ecx_5 + 0x14) != eax)
    *(ecx_5 + 0x10) = ebp_2
    *(ecx_5 + 0x14) = eax
    *(ecx_5 + 0x64) = 1

for (int32_t* i = *(arg1 + 0x20); i != *(arg1 + 0x24); i = &i[1])
    (*(**i + 0x1c))(*(arg1 + 0x30), arg2, arg3)

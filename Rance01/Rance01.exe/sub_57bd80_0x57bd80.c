...
if (ecx_1 != 0)
    ...
    if (result != 0)
        float var_8 = fconvert.s(float.t(*(arg1 + 0x34)))
        long double x87_r6 = fconvert.t(0.5)
        *result = fconvert.s(float.t(*(arg1 + 0x30)) - x87_r6)
        ...
        result[7] = fconvert.s(
            fconvert.t(fconvert.s(float.t(*(arg1 + 0x38)) + float.t(*(arg1 + 0x30)))) - x87_r6)
        ...
        float var_4_1 = fconvert.s(float.t(*(arg1 + 0x3c)) + float.t(*(arg1 + 0x34)))
        result[0xe] = fconvert.s(float.t(*(arg1 + 0x30)) - x87_r6)
        ...
        float var_8_2 = fconvert.s(float.t(*(arg1 + 0x3c)) + float.t(*(arg1 + 0x34)))
        float var_4_2 = fconvert.s(float.t(*(arg1 + 0x38)) + float.t(*(arg1 + 0x30)))

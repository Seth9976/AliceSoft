...
if (sub_624670(arg5, *(arg1 + 0xdc), arg3, &var_458) != 0)
    ...
    int128_t* eax_18 = (*(**(edi_1 + 8) + 0x28))((*(**(edi_1 + 4) + 0x1c))(arg5), arg3)
    ...
    if (eax_18 == 0)
        ...
        char var_410
        _swprintf(&var_410, 0x400, &data_733d08)
        ...
        lprc_2 += (*(arg1 + 0xcc) * eax_22) u>> 1
        sub_628030(*(arg1 + 0x128) - var_464_1 + 1, arg2, arg1, &lprc_2, arg4)
        int32_t esi_6 = var_480 + *(arg1 + 0x128) - var_464_1 + eax_22 + 4
        sub_6220e0(arg2, arg1, lprc_2, arg4, " : ")
        int32_t eax_32
        int32_t edx_13
        edx_13:eax_32 = sx.q(*(arg1 + 0xcc) * 3)
        lprc_2 += (eax_32 - edx_13) s>> 1
        var_480 = esi_6
        ...
        if (sub_624740(*(arg1 + 0xdc), arg5, arg3, &var_43c) != 0)
            void* esi_8 = *(arg1 + 0xdc)
            void* eax_41 = (*(**(esi_8 + 8) + 0x24))((*(**(esi_8 + 4) + 0x1c))(arg5), arg3) - 0xa
            ...
            int32_t result_1 = var_480 + var_42c_1
            int32_t lprc = lprc_1
            ...
            if (*(arg1 + 0x134) == arg3)
                ...
                if (eax_41 u<= 0x25)
                    eax_54 = sub_629b10(eax_41)
                
                HBRUSH hbr
                
                if (eax_41 u<= 0x25 && eax_54 == 0)
                    hbr = *(arg1 + 0x170)
                else
                    hbr = *(arg1 + 0x16c)

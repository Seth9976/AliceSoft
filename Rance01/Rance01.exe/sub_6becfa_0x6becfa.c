...
if ((arg1.b & 8) != 0 && (arg3 & 1) != 0)
    ...
    if (eax_2 == 0)
        ...
        if (p_4)
        label_6bedd4:
            *ecx_3 = fconvert.d(fneg(fconvert.t(data_78ced0)))
        else
            *ecx_3 = fconvert.d(fconvert.t(data_78ced0))
    else if (eax_2 == 0x400)
        ...
        *ecx_3 = fconvert.d(fconvert.t(data_78cee0))
    else if (eax_2 == 0x800)
        ...
        if (not(p_2))
            *arg2 = fconvert.d(fconvert.t(data_78ced0))
        else
            *arg2 = fconvert.d(fneg(fconvert.t(data_78cee0)))
    else if (eax_2 == 0xc00)
        ...
        long double x87_r0_2 = fconvert.t(data_78cee0)

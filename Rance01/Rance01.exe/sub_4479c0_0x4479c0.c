    ...
    do
        ...
        if (ecx_27 != 0)
            ...
            if (j_6 s> 0)
                ...
                do
                    ...
                    char edx_25 =
                        (((((zx.d(xmm2_11.b) * eax_26) s>> 8) - eax_26) * ecx_36) s>> 8).b + *esi_1
                    esi_1 += 4
                    *(esi_1 - 4) = edx_25
                    uint32_t eax_28 = zx.d(*(esi_1 - 2))
                    edi_1 += 4
                    *(esi_1 - 3) +=
                        (((((zx.d(xmm2_11:1.b) * eax_27) s>> 8) - eax_27) * ecx_36) s>> 8).b
                    ebx_1 = &(*ebx_1)[1]
                    j = j_3
                    j_3 -= 1
                    *(esi_1 - 2) +=
                        (((((zx.d(xmm2_11:2.b) * eax_28) s>> 8) - eax_28) * ecx_36) s>> 8).b
                while (j != 1)
                result = result_1
        ...
        if (result s> 0)
            ...
            do
                ...
                uint32_t xmm4_5[0x4] = _mm_adds_epu8(xmm4_3, xmm7) & xmm2_3
                int32_t xmm2_16[0x4] = __pmullw_xmmdq_memdq(_mm_srli_epi32(xmm2_14, 0x18), xmm2_1)
                uint32_t xmm4_6[0x4] = _mm_srli_epi32(xmm4_5, 8)
                uint32_t xmm2_17[0x4] = _mm_srli_epi32(xmm2_16, 8)
                ...
                uint16_t xmm1_5[0x8] = _mm_srli_epi16(_mm_mullo_epi16(xmm3_2 & xmm4_6, xmm5_5), 8)
                ...
                int32_t xmm1_7[0x4] = _mm_mullo_epi16(xmm1_6, xmm4_9)
        ...
        if (j_5 s> 0)
            ...
            do
                int32_t ecx_38 = zx.d(*(ebx_1 + 3)) * arg13
                uint32_t eax_32 = zx.d(*esi_1)
                int24_t xmm2_25 = _mm_adds_epu8(
                    _mm_packus_epi16(
                        _mm_srli_epi16(_mm_mullo_epi16(_mm_unpacklo_epi8(zx.o(*edi_1), 0), xmm1_1), 
                            8), 
                        zx.o(0)), 
                    xmm4)
                uint32_t eax_33 = zx.d(*(esi_1 + 1))
                int32_t ecx_39 = ecx_38 s>> 8
                char edx_44 =
                    (((((zx.d(xmm2_25.b) * eax_32) s>> 8) - eax_32) * ecx_39) s>> 8).b + *esi_1
                esi_1 += 4
                *(esi_1 - 4) = edx_44
                result = zx.d(*(esi_1 - 2))
                edi_1 += 4
                *(esi_1 - 3) += (((((zx.d(xmm2_25:1.b) * eax_33) s>> 8) - eax_33) * ecx_39) s>> 8).b
                ebx_1 = &(*ebx_1)[1]
                j_2 = j_4
                j_4 -= 1
                *(esi_1 - 2) += (((((zx.d(xmm2_25:2.b) * result) s>> 8) - result) * ecx_39) s>> 8).b
            while (j_2 != 1)

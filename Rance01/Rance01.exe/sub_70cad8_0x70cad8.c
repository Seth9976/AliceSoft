...
if (z)
    ...
    if (data_797954 == 0)
        return __startOneArgErrorHandling(eax, 0x12, result, 0x796e00, var_4)
else
    int16_t x87control
    int16_t x87status_1
    ...
    if (test_bit(arg1:1.b, 2))
        ...
        long double x87_r0 = data_75c8fa
    ...
    if (data_797954 == 0)
        ...
        if (arg1.w != 0x27f)
            ...
            if (arg1.w != 0)
                ...
                if (arg1.w != 0)
                    return __startOneArgErrorHandling(8, 0x12, result, 0x796e00, var_4)

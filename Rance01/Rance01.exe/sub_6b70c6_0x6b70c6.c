...
eax, x87control_1 = sub_6bf25a(x87control, 0x133f, 0xffff)
...
if (ecx_1.w != 0x7ff0)
    ...
    if (arg5 s>= 0)
        ...
        label_6b71ad:
            ...
            if (eax_4 s> 0x400)
                ...
                var_1c_2.q = fconvert.d(sub_6be8a5(var_1c_2, eax_4 - 0x600))
            ...
            if (eax_4 s< 0xfffffc03)
                ...
                x87_r7_16 = sub_6be8a5(var_1c_1, eax_4 + 0x600)
                goto label_6b721f
            ...
            int64_t var_24
            var_24:4.d = 0xffff
            arg4 = fconvert.d(sub_6be8a5(var_1c_3, eax_4))
            var_24.d = eax
            sub_6bf25a(x87control_1, var_24)
            return fconvert.t(arg4)
        
    label_6b71ba:
        var_1c_1.q = fconvert.d(st0_3)
        var_1c_1.q =
            fconvert.d(__copysign(fconvert.d(fconvert.t(data_78ced0)), var_1c_1, ecx_1, eax))
        var_24_2 = (fconvert.d(float.t(arg5))).d
        var_2c:4.d = ecx_4
        var_2c.d = ecx_4
    label_6b71db:
    ...
    int32_t eax_2
    int32_t edx
    eax_2, edx = sub_6be8d2(var_18_1, ecx_1)
    int32_t var_1c
    ...
    if (eax_2 s> 0)
        ...
        var_2c:4.d = 0x19
        return sub_6bf034(eax_2, edx, ecx_1)
...
label_6b7140:
    ...
    var_34_1 = 8
return sub_6bf15f(var_34_1, 0x19, var_2c_1, var_24_2)

...
if (arg2 != 0)
    ...
    if ((eax_2 s> 0 || (eax_2 s>= 0 && ecx_1 u>= 0))
        ...
        if (_rand_s(&var_c) == 0 && sub_6bc5f2(&var_10) == 0 && sub_6bc61f(&var_8) == 0)
            int32_t ecx_5 = arg2[1]
            int32_t edi_2 = *arg2
            int32_t result
            
            if (ecx_5 s< 0 || (ecx_5 s<= 0 && edi_2 u<= 0x3f480))
                result = sub_6b66ab(arg1, arg2)
                ...
                *(arg1 + 8) = eax_32
                ...
                result = sub_6b66ab(arg1, &var_18)
                
                if (result != 0)
                    return result
                
                if (var_c != result && sub_6bc584(arg1) != 0)
                    int32_t eax_11
                    int32_t edx_2

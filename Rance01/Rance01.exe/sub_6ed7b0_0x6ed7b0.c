...
int32_t var_74 = data_79b9e8
int32_t var_70 = data_79b9ec
int32_t var_6c = data_79b9f0
int32_t var_68 = data_79b9f4
void var_64
...
if (zx.d(sub_6e0c40(&var_64, &var_74)) != 0)
    return (*(ebx + 0xe4))(ebp, ebp + 0x100, ebp + 0x180, ebp + 0x200, edi_1, esi)
...
if (zx.d(sub_6e0c70(&var_44, &data_79b8e0)) != 0)
    sub_6ecd60(ebp, ebp + 0x100, ebp + 0x180, ebp + 0x200, edi_1, &var_44, esi)
...
return sub_6ecd60(ebp + 0x80, ebp + 0x108, ebp + 0x188, ebp + 0x280, edi_1 + 0x20, &var_44, esi)

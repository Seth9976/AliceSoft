...
if (ebp_29 s< ecx_1)
    ...
    do
        ...
        if (esi_20 s< edx_1)
            do
                int32_t eax_2 = sx.d(*(i + arg1 + (esi_20 << 1)))
                int32_t ecx_8 = (adc.d(esi_20 - 0x80000000, 0x80000000, esi_20 u>= 0x80000000)
                    s>> 1) + (adc.d(ebp_29 - 0x80000000, 0x80000000, ebp_29 u>= 0x80000000) s>> 1 << 2)
                int32_t edx_9 = sx.d(*(&var_8c + (ecx_8 << 1))) + eax_2
                ...
                *(ebx_2 + (esi_20 << 2)) = neg.b(edx_9.b) - 1
                int32_t edx_13 = neg.d(sx.d(*(&var_6c + (ecx_8 << 1)))) + eax_2
                ...
                int32_t ecx_9 = sx.d(*(&var_4c + (ecx_8 << 1)))
                *(ebx_2 + (esi_20 << 2) + 1) = neg.b(edx_13.b) - 1
                int32_t eax_3 = eax_2 + ecx_9
                ...
                *(ebx_2 + (esi_20 << 2) + 2) = neg.b(eax_3.b) - 1
                *(ebx_2 + (esi_20 << 2) + 3) = *(arg4 + i + (esi_20 << 1))
                esi_20 += 1
                edx_1 = arg6[2]
            while (esi_20 s< edx_1)

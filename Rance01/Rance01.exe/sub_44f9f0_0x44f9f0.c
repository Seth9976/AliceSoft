...
arg3:3.b = arg15[8]
arg10:3.b = arg15[4]
char ecx_16 = arg15[0xc]
arg15:3.b = *arg15
arg5:3.b = arg14[8]
arg16:3.b = arg14[4]
char ecx_18 = arg14[0xc]
        ...
        if (arg8 s> 0)
            ...
            do
                ...
                int32_t ecx_38 = (zx.d(*(var_c + 3)) * zx.d(*((ecx_31 s>> 8) + zx.d(ecx_18) + edi))
                    * arg13) s>> 0x10
                *esi +=
                    (((zx.d(*(zx.d(edx_18.b) + (eax_29 << 8) + ebx)) - eax_29) * ecx_38) s>> 8).b
                uint32_t eax_36 = zx.d(esi[1])
                esi[1] +=
                    (((zx.d(*(zx.d(arg9:1.b) + (eax_36 << 8) + ebx)) - eax_36) * ecx_38) s>> 8).b
                uint32_t eax_43 = zx.d(esi[2])
                esi[2] +=
                    (((zx.d(*(zx.d(arg9:2.b) + (eax_43 << 8) + ebx)) - eax_43) * ecx_38) s>> 8).b
                var_8 = &var_8[1]
                var_c += 4
                esi = &esi[4]
                j = j_1

...
int32_t eax_6 = (&data_798100)[arg1 s>> 5]
    ...
    if (arg3 == 0 || (ecx & 2) != 0)
        ...
        if (eax_9 == 1)
            ...
            if (ebx_1 != 0)
                uint32_t eax_23
                int32_t edx_3
                eax_23, edx_3 = sub_6b5a9a(eax_20, edx_2, arg3, arg1, 0, 0, FILE_CURRENT)
                int32_t ecx_2 = (&data_798100)[arg1 s>> 5]
        ...
        label_6bd570:
            ...
            lpMultiByteStr = ebx_1
        label_6bd5f4:
            void* ecx_4 = (&data_798100)[arg1 s>> 5] + esi_2
            void* lpBuffer = ebx_1
            ...
            if ((*(ecx_4 + 4) & 0x48) != 0)
                ...
                if (ecx_4.b != 0xa && arg3 != 0)
                    ...
                    *ebx_1 = ecx_4.b
                    lpBuffer = &ebx_1[1]
                    result_2 = 1
                    *(esi_2 + (&data_798100)[arg1 s>> 5] + 5) = 0xa
                    
                    if (var_6_1 != 0)
                        int32_t ecx_6
                        ecx_6.b = *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x25)
                        ...
                        if (ecx_6.b != 0xa && arg3 != 0)
                            *lpBuffer = ecx_6.b
                            ...
                            arg3 -= 1
                            result_2 = 2
                            *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x25) = 0xa
                            
                            if (var_6_1 == 1)
                                int32_t ecx_8
                                ecx_8.b = *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x26)
                                ...
                                if (ecx_8.b != 0xa && arg3 != 0)
                                    *lpBuffer = ecx_8.b
                                    ...
                                    arg3 -= 1
                                    result_2 = 3
                                    *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x26) = 0xa
            
            uint32_t numberOfBytesRead
            BOOL eax_25
            int32_t edx_4
            eax_25, edx_4 = ReadFile(*(esi_2 + (&data_798100)[arg1 s>> 5]), lpBuffer, arg3, 
            ...
            if (eax_25 == 0 || numberOfBytesRead_1 s< 0 || numberOfBytesRead_1 u> arg3)
                ...
                char* eax_27 = esi_2 + (&data_798100)[arg1 s>> 5] + 4
                    ...
                    if (var_6_1 == 2)
                        ...
                        if (lpMultiByteStr_2 u< eax_52)
                            do
                                ...
                                if (ecx_20 == 0x1a)
                                    char* esi_3 = esi_2 + (&data_798100)[arg1 s>> 5] + 4
                                ...
                                if (ecx_20 != 0xd)
                                    *lpMultiByteStr_2 = ecx_20.w
                                    ...
                                    eax_56, ecx_24, edx_7 = ReadFile(
                                        *(esi_2 + (&data_798100)[arg1 s>> 5]), &buffer, 2, 
                                        &numberOfBytesRead, nullptr)
                                ...
                                label_6bd97d:
                                    int32_t eax_58 = (&data_798100)[arg1 s>> 5]
                                    
                                    if ((*(esi_2 + eax_58 + 4) & 0x48) == 0)
                                        if (lpMultiByteStr_2 == lpMultiByteStr && buffer == 0xa)
                                            goto label_6bd93f
                                        
                                        sub_6b5a9a(eax_58, edx_7, ecx_24, arg1, 0xfffffffe, 
                                        ...
                                        *lpMultiByteStr_2 = 0xd
                                        ecx_24.b = buffer.b
                                        *(esi_2 + (&data_798100)[arg1 s>> 5] + 5) = ecx_24.b
                                        ecx_24.b = buffer:1.b
                                        *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x25) = ecx_24.b
                                        *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x26) = 0xa
                                        lpMultiByteStr_2 += 2
                                else if (*(arg3 + 2) != 0xa)
                                    arg3 += 2
                        ...
                        if (lpMultiByteStr_1 u< eax_29)
                            do
                                ...
                                if (eax_29.b == 0x1a)
                                    char* eax_39 = esi_2 + (&data_798100)[arg1 s>> 5] + 4
                                ...
                                if (eax_29.b != 0xd)
                                    *lpMultiByteStr_1 = eax_29.b
                                    ...
                                    eax_34, numberOfBytesRead_1, edx_4 = ReadFile(
                                        *(esi_2 + (&data_798100)[arg1 s>> 5]), &buffer_1, 1, 
                                        &numberOfBytesRead, nullptr)
                                    ...
                                    if (eax_34 != 0)
                                        ...
                                        *lpMultiByteStr_1 = 0xd
                                        ...
                                        label_6bd757:
                                            int32_t eax_36 = (&data_798100)[arg1 s>> 5]
                                            
                                            if ((*(esi_2 + eax_36 + 4) & 0x48) == 0)
                                                if (lpMultiByteStr_1 != lpMultiByteStr
                                                        || buffer_1 != 0xa)
                                                    numberOfBytesRead_1, edx_4 = sub_6b5a9a(eax_36, 
                        ...
                        if (var_6_1 == 1 && result_3 != 0)
                            ...
                            if (numberOfBytesRead_1.b s< 0)
                                ...
                                edx_4.b = *ebx_2
                                int32_t ecx_12 = sx.d(*(zx.d(edx_4.b) + 0x78c5a0))
                                
                                if (ecx_12 != 0)
                                    if (ecx_12 + 1 != eax_41)
                                        int32_t ecx_14 = (&data_798100)[arg1 s>> 5]
                                        
                                        if ((*(ecx_14 + esi_2 + 4) & 0x48) == 0)
                                            int32_t eax_44
                                            int32_t edx_5
                                            edx_5:eax_44 = sx.q(neg.d(eax_41))
                                            sub_6b5a9a(eax_44, edx_5, ecx_14, arg1, eax_44, edx_5, 
                                                FILE_CURRENT)
                                        else
                                            void* ebx_3 = &ebx_2[1]
                                            *(ecx_14 + esi_2 + 5) = edx_4.b
                                            ...
                                            if (eax_41 s>= 2)
                                                edx_4.b = *ebx_3
                                                *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x25) =
                                                    edx_4.b
                                                ebx_3 += 1
                                            
                                            if (eax_41 == 3)
                                                edx_4.b = *ebx_3
                                                *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x26) =
                                                    edx_4.b
                                                ebx_3 += 1
                            ...
                            label_6bd86d:
                                ...
                                if (result_4 != 0)
                                    ...
                                    result_2 *= 2
                                    *(esi_2 + (&data_798100)[arg1 s>> 5] + 0x30) = ecx_19
                                else

...
int32_t var_1c = 0
char var_2c = 0
sub_401270(&var_2c, 0x12, "DPPartsPartsWindow")
int32_t var_4 = 0

if (*(arg1 + 0x84) == 0)
    struct dpparts::CWindow::VTable** eax_6 = operator new(0x208)
    ...
    if (eax_6 == 0)
        ...
        eax_12 = sub_651d00(eax_8, eax_9, eax_6, *(arg1 + 0x18), var_3c, eax_10, eax_7)
    
    var_4.b = 0
    int32_t edx_2 = *(arg1 + 0x8c)
    *(arg1 + 0x84) = eax_12
    eax_12[0x26] = edx_2
    *(*(arg1 + 0x84) + 0x94) = *(arg1 + 0x7c)

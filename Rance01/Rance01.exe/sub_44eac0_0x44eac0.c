    ...
    do
            ...
            if (j_6 s> 0)
                ...
                do
                    ...
                    *(esi_1 - 4) = eax_20
                    ...
                    uint32_t eax_24 = zx.d(*((eax_21 << 8) + zx.d(*(edi_1 + 1)) + ebx_1)) - eax_21
                    edi_1 += 4
                    *(esi_1 - 3) += ((eax_24 * ecx_19) s>> 8).b
        ...
        if (result s> 0)
            ...
            do
                ...
                uint32_t xmm2_7[0x4] = _mm_srli_epi32(
                    __pmullw_xmmdq_memdq(_mm_srli_epi32(xmm4_1 & xmm0_10, 0x10), xmm0_3), 8)
                int32_t xmm4_4[0x4] = _mm_slli_epi32(xmm2_7, 0x10) | xmm2_7
                uint32_t xmm2_9[0x4] = *esi_1 ^ xmm0_5
                uint16_t xmm1_5[0x8] = _mm_srli_epi16(_mm_mullo_epi16(xmm3_1 & xmm2_1, xmm4_4), 8)
                int32_t xmm0_11[0x4] = _mm_mullo_epi16(xmm0_10, xmm4_4)
                int32_t xmm1_7[0x4] = _mm_mullo_epi16(xmm1_5 ^ xmm3_1, xmm3_1 & xmm2_9)
                ...
                uint16_t xmm1_10[0x8] = _mm_srli_epi16(
                    _mm_subs_epi16(xmm5_1, 
                        _mm_mullo_epi16(xmm0_12 ^ xmm3_1, xmm3_1 & _mm_srli_epi32(xmm2_9, 8))), 
                    8)
        ...
        if (j_5 s> 0)
            ...
            do
                ...
                char eax_41 =
                    (((zx.d(*(zx.d(*edi_1) + (eax_35 << 8) + ebx_1)) - eax_35) * ecx_22) s>> 8).b
                    + *esi_1
                esi_1 += 4
                *(esi_1 - 4) = eax_41
                uint32_t eax_42 = zx.d(*(esi_1 - 3))
                uint32_t eax_45 = zx.d(*((eax_42 << 8) + zx.d(*(edi_1 + 1)) + ebx_1)) - eax_42
                edi_1 += 4
                *(esi_1 - 3) += ((eax_45 * ecx_22) s>> 8).b
                uint32_t eax_48 = zx.d(*(esi_1 - 2))
                result.b = (((zx.d(*((eax_48 << 8) + zx.d(*(edi_1 - 2)) + ebx_1)) - eax_48)
                    * ecx_22) s>> 8).b + *(esi_1 - 2)
                j_2 = j_4
                j_4 -= 1
                *(esi_1 - 2) = result.b
            while (j_2 != 1)

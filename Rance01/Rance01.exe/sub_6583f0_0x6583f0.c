...
if (result u> 0)
    while (true)
        ...
        sub_65e420(ecx_3, 0, edi_2, ebp, 0x54000000, ecx_3 * result_1, 0, *(arg1 + 0x20), nullptr, 
            *(arg1 + 0x24))
        ebp[0x24] = arg1 + 0x34
        ebp[0x23] = arg1 + 0x36
        ebp[0x25] = *(arg1 + 0x28)
        ...
        *(ebp + 0x99) = *(arg1 + 0x55)
        ebp[0x26].b = edx_5
        *(ebp + 0x9a) = eax_13.b
        int32_t eax_14 = *(arg1 + 0x7c)
        int32_t edx_6
        
        if (&var_3c u< eax_14)
            edx_6 = *(arg1 + 0x78)
        
        if (&var_3c u>= eax_14 || edx_6 u> &var_3c)
            int32_t ecx_10 = *(arg1 + 0x80)
            
            if (eax_14 == ecx_10)
                int32_t edx_10 = *(arg1 + 0x78)
                int32_t eax_20 = (eax_14 - edx_10) s>> 2
                
                if (eax_20 u> 0x3ffffffe)
                    sub_6b47bf("vector<T> too long")
                    noreturn
                
                int32_t ecx_12 = (ecx_10 - edx_10) s>> 2
                
                if (eax_20 + 1 u> ecx_12)
                    uint32_t edx_12 = ecx_12 u>> 1
                    int32_t ecx_13
                    
                    if (0x3fffffff - edx_12 u>= ecx_12)
                        ecx_13 = ecx_12 + edx_12
                    else
                        ecx_13 = 0
                    
                    if (ecx_13 u< eax_20 + 1)
                        ecx_13 = eax_20 + 1
                    
                    sub_6b0560(arg1 + 0x78, ecx_13)
            
            void** eax_22 = *(arg1 + 0x7c)
            
            if (eax_22 != 0)
                *eax_22 = ebp
        else
            int32_t ecx_5 = *(arg1 + 0x80)
            
            if (eax_14 == ecx_5)
                int32_t eax_16 = (eax_14 - edx_6) s>> 2
                
                if (eax_16 u> 0x3ffffffe)
                    sub_6b47bf("vector<T> too long")
                    noreturn
                
                int32_t ecx_7 = (ecx_5 - edx_6) s>> 2
                
                if (eax_16 + 1 u> ecx_7)
                    uint32_t edx_8 = ecx_7 u>> 1
                    int32_t ecx_8
                    
                    if (0x3fffffff - edx_8 u>= ecx_7)
                        ecx_8 = ecx_7 + edx_8
                    else
                        ecx_8 = 0
                    ...
                    sub_6b0560(arg1 + 0x78, ecx_8)
            
            int32_t* eax_18 = *(arg1 + 0x7c)
            
            if (eax_18 != 0)
                *eax_18 = *(*(arg1 + 0x78) + ((&var_3c - edx_6) s>> 2 << 2))

    ...
    do
        ...
        if (edi_6 s< edx_1)
            ...
            do
                ...
                int32_t ecx_4 = sx.d(*(&var_ec + (edx_4 << 1))) + eax_2
                ...
                char* ecx_5 = edi_6 * 3
                int32_t ebx_3 = sx.d(*(&var_ac + (edx_4 << 1)))
                ecx_5[var_1c_1] = edx_5.b
                ...
                ebx_2 = var_1c_1
                ecx_5[ebx_2 + 1] = edx_6.b
                int32_t eax_3 = eax_2 + sx.d(*(&var_6c + (edx_4 << 1)))

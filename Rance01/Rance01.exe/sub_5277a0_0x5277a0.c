...
if (arg1 s>= 0)
    ...
    if (arg1 s< (*(ecx_1 + 0x44) - *(ecx_1 + 0x40)) s>> 2)
        ...
        if (eax_2 != 0)
            ...
            float var_60 = fconvert.s(fconvert.t(eax_4[4]) * x87_r6 + fconvert.t(*eax_4) * x87_r6
                + fconvert.t(eax_4[8]))
            float var_5c = fconvert.s(fconvert.t(eax_4[5]) * x87_r6 + fconvert.t(eax_4[1]) * x87_r6
                + fconvert.t(eax_4[9]))
            long double x87_r7_7 = x87_r6 * fconvert.t(eax_4[2]) + fconvert.t(eax_4[6]) * x87_r6
                + fconvert.t(eax_4[0xa])
            eax_4.b = 1
            float var_58 = fconvert.s(x87_r7_7)

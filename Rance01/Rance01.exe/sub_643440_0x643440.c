...
while (edx s< eax)
    void* ecx_1 = edx * 0x8c
    int32_t esi_1 = *(ecx_1 + arg4 + 0x30)
    int32_t ebx_1 = *(ecx_1 + arg4 - 0x5c)
    int32_t eax_1 = *(ecx_1 + arg4 - 0x54)
    int32_t* ecx_2 = ecx_1 + arg4
    
    if (esi_1 s< ebx_1)
        edx -= 1
    else if (esi_1 s<= ebx_1)
        int32_t esi_2 = ecx_2[0xd]
        int32_t ebx_2 = ecx_2[-0x16]
        
        if (esi_2 s< ebx_2)
            edx -= 1
        else if (esi_2 s<= ebx_2)
            int32_t esi_3 = ecx_2[0xe]
...
return sub_643a20(edi, var_4, arg6, arg4)

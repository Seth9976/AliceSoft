...
st0 = _m_punpckldq(st0, st1.d)
int16_t temp0_217[0x4] = _m_pmaddwd(var_1c_3, st5)
int64_t temp0_218 = _m_punpckhdq(st2, st1.d)
st4 = _m_pmaddwd(temp0_173, st6)
st1 = st3
st0 = _m_psradi(__paddd_mmxq_memq(_m_paddd(st0, temp0_218), data_78e2d8), 0xa) & data_78e300
st3 = _m_punpckldq(st3, st4.d)
int64_t temp0_224 = _m_punpckhdq(st1, st4.d)
st2 = _m_pmaddwd(var_1c_3, st6)
st3 = _m_psradi(__paddd_mmxq_memq(_m_paddd(st3, temp0_224), data_78e2d8), 0xa) & data_78e300
st7 = _m_punpckldq(temp0_217, st2.d)
st0 |= _m_psllqi(st3, 0x10)
st7 = __paddd_mmxq_memq(_m_paddd(st7, _m_punpckhdq(temp0_217, st2.d)), data_78e2d8)
...
st1 = _m_psllqi(
    ...
    0x10) | st7
st0 = _m_punpckldq(st0, st1.d)
int64_t temp0_244 = _m_punpckhdq(st4, st1.d)
*ebx = st0
ebx[0x10] = temp0_244
return arg1

...
int32_t var_1c = 0
char var_2c = 0
sub_401270(&var_2c, 0x11, "DPPartsViewWindow")
int32_t var_4 = 0

if (*(arg1 + 0x88) == 0)
    struct dpparts::CWindow::VTable** eax_6 = operator new(0x1dc)
    ...
    if (eax_6 == 0)
        ...
        eax_12 = sub_65c3a0(eax_8, eax_9, eax_6, *(arg1 + 0x18), var_3c, eax_10, eax_7)
    
    var_4.b = 0
    *(arg1 + 0x88) = eax_12
    eax_12[0x3d] = arg1 + 0x80
    sub_65de80(*(arg1 + 0x88))

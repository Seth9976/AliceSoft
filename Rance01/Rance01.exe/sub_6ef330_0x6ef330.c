...
int32_t var_54 = data_79ba18
int32_t var_50 = data_79ba1c
int32_t var_4c = data_79ba20
int32_t var_48 = data_79ba24
void var_44
...
if (zx.d(sub_6e0c40(&var_44, &var_54)) != 0)
    return (*(ebx + 0xec))(ebp, ebp + 0x80, ebp + 0x100, ebp + 0x180, edi_1, esi)
...
return sub_6ef0e0(ebp, ebp + 0x80, ebp + 0x100, ebp + 0x180, edi_1, &var_24, esi)

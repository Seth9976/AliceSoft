...
if (var_51 != 0)
    ...
    if (sub_51b970(&var_48, &var_4c).b != 0)
        if (sub_402680(0x755230, &var_48).b == 0)
            if (sub_402680(0x75523c, &var_48) != 0)
                *(arg2 + 4) = 1
                goto label_4de8e0
            
            if (sub_402680(0x755254, &var_48).b != 0)
                *(arg2 + 4) = 2
                goto label_4de8e0
            
            if (sub_402680(0x75525c, &var_48).b != 0)
                *(arg2 + 4) = 3
                goto label_4de8e0

    ...
    do
        if (arg8 s> 0)
            ...
            do
                ...
                uint32_t eax_17 = zx.d(edx_7)
                int32_t ebx_4 = ((zx.d(*edi) * eax_17) s>> 8) - eax_17
                eax_17.b = esi[1]
                *esi = ((ebx_4 * ecx_19) s>> 8).b + edx_7
                uint32_t edx_8 = zx.d(eax_17.b)
                char ebx_12 =
                    (((((zx.d(edi[1]) * edx_8) s>> 8) - edx_8) * ecx_19) s>> 8).b + eax_17.b
                eax_17.b = esi[2]
                esi[1] = ebx_12
                uint32_t edx_9 = zx.d(eax_17.b)
                arg10 = &arg10[1]
                esi[2] = (((((zx.d(edi[2]) * edx_9) s>> 8) - edx_9) * ecx_19) s>> 8).b + eax_17.b
                esi = &esi[4]
                edi = &edi[4]
                j = arg3
                arg3 -= 1

    ...
    do
        if (arg8 s> 0)
            ...
            do
                ...
                uint32_t ecx_31 = zx.d(*(var_8 + 3))
                *esi +=
                    (((zx.d(*(zx.d(edx_15.b) + (eax_27 << 8) + ebx)) - eax_27) * ecx_31) s>> 8).b
                uint32_t eax_34 = zx.d(esi[1])
                esi[1] +=
                    (((zx.d(*(zx.d(arg9:1.b) + (eax_34 << 8) + ebx)) - eax_34) * ecx_31) s>> 8).b
                uint32_t eax_41 = zx.d(esi[2])
                esi[2] +=
                    (((zx.d(*(zx.d(arg9:2.b) + (eax_41 << 8) + ebx)) - eax_41) * ecx_31) s>> 8).b
                var_4 = &var_4[1]
                var_8 += 4
                esi = &esi[4]
                j = j_1

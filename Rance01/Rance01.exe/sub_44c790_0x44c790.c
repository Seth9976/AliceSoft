...
uint32_t* var_68_1 = (*(*arg9 + 8))(arg10, arg11)
...
int128_t xmm0_5 = xmm3_2 | _mm_slli_epi32(xmm3_2, 8)
int32_t xmm0_7[0x4] = _mm_mullo_epi16(xmm3_2, xmm3_2)
    ...
    do
        ...
        if (ecx_16 != 0)
            ...
            if (j_6 s> 0)
                ...
                do
                    ...
                    int32_t ecx_24 = (zx.d(*(var_68_1 + 3)) * arg12) s>> 8
                    var_68_1 = &var_68_1[1]
                    *esi_1 += (((zx.d(*(zx.d(*edi_1) + (eax_21 << 8) + ebx_1)) - eax_21) * ecx_24)
                        s>> 8).b
                    uint32_t eax_28 = zx.d(*(esi_1 + 1))
                    esi_1 += 4
                    char eax_33 = (((zx.d(*((eax_28 << 8) + zx.d(*(edi_1 + 1)) + ebx_1)) - eax_28)
                        * ecx_24) s>> 8).b + *(esi_1 - 3)
                    edi_1 += 4
                    *(esi_1 - 3) = eax_33
        ...
        if (result s> 0)
            ...
            do
                ...
                uint32_t (* ecx_25)[0x4] = var_68_1
                int32_t xmm1_3[0x4] = xmm3_2 & _mm_srli_epi32(xmm2_1, 8)
                uint32_t xmm2_6[0x4] =
                    _mm_srli_epi32(__pmullw_xmmdq_memdq(_mm_srli_epi32(*ecx_25, 0x18), xmm0_3), 8)
                int32_t xmm4_3[0x4] = _mm_slli_epi32(xmm2_6, 0x10) | xmm2_6
                uint32_t xmm2_8[0x4] = *esi_1 ^ xmm0_5
                int32_t xmm0_13[0x4] =
                    _mm_srli_epi16(_mm_mullo_epi16(xmm3_2 & xmm2_1, xmm4_3), 8) ^ xmm3_2
                int32_t xmm1_4[0x4] = _mm_mullo_epi16(xmm1_3, xmm4_3)
                int32_t xmm0_14[0x4] = _mm_mullo_epi16(xmm0_13, xmm3_2 & xmm2_8)
                uint16_t xmm1_5[0x8] = _mm_srli_epi16(xmm1_4, 8)
                int32_t xmm6_2[0x4] = _mm_subs_epi16(xmm5_1, xmm0_14)
                uint16_t xmm0_17[0x8] = _mm_srli_epi16(
                    _mm_subs_epi16(xmm5_1, 
                        _mm_mullo_epi16(xmm1_5 ^ xmm3_2, xmm3_2 & _mm_srli_epi32(xmm2_8, 8))), 
                    8)
                *esi_1 = _mm_srli_epi16(xmm6_2, 8) | _mm_slli_epi32(xmm0_17, 8)
                esi_1 = &esi_1[1]
                edi_1 = &edi_1[1]
                j_1 = result
                result -= 1

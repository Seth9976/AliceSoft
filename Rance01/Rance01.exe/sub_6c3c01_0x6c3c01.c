...
if (eax_4 s> 0)
    ...
    sub_6b49d0(esi_2 + 1, esi_2, _strlen(esi_2) + 1)
    *esi_2 = 0x30
    esi_3 = esi_2 + 1

if (arg5 s> 0)
    sub_6b49d0(esi_3 + 1, esi_3, _strlen(esi_3) + 1)
    char* eax_11
    ...
    *esi_3 = eax_11.b
    ...
    if (edi_2 s< 0)
        ...
        sub_6c35fe(esi_3 + 1, arg5)
        sub_6bc670(esi_3 + 1, 0x30, arg5)

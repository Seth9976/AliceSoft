...
double xmm1_4[0x2] = __mulpd_xmmpd_mempd(xmm1_3, data_765170)
double xmm0_2[0x2] = _mm_sub_pd(xmm0_1, xmm4_1)
double xmm5_2 = __andpd_xmmxuq_memxuq(6.7164665968574641e-14 f* xmm1_3 f+ xmm0_1, data_765190)
...
double xmm7_1[0x2] = _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x763b40), xmm0_3)
double xmm2_4 = _mm_sub_pd(xmm2_3, xmm1_4)
double xmm1_6[0x2] = _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x763b60), xmm0_3)
double xmm4_3[0x2] = _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x763b90), xmm0_3)
double xmm2_5[0x2] = xmm2_4 + xmm3_3 - xmm5_2
double xmm0_4[0x2] = _mm_mul_pd(xmm0_3, xmm0_3)
double xmm7_2[0x2] = __addpd_xmmpd_mempd(xmm7_1, *(0x763b30 + ((ecx_1 * 5 + edx_2) << 4)))
double xmm1_8[0x2] =
    _mm_mul_pd(__addpd_xmmpd_mempd(xmm1_6, *(((ecx_1 * 5 + edx_2) << 4) + 0x763b50)), xmm0_4)
double xmm4_4[0x2] = __addpd_xmmpd_mempd(xmm4_3, *(((ecx_1 * 5 + edx_2) << 4) + 0x763b80))
double xmm7_3[0x2] = _mm_add_pd(xmm7_2, xmm1_8)
double xmm1_10[0x2] = _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x763ba0), xmm0_4)
double xmm0_5[0x2] = _mm_mul_pd(xmm0_4, xmm0_4)
double xmm4_5[0x2] = _mm_add_pd(xmm4_4, xmm1_10)
double xmm7_4[0x2] =
    _mm_add_pd(xmm7_3, _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x763b70), xmm0_5))
double xmm3_6[0x2] = _mm_mul_pd(xmm0_3, xmm0_5)
double xmm1_14[0x2] = __mulpd_xmmpd_mempd(xmm0_3, *(((ecx_1 * 5 + edx_2) << 4) + 0x763bc0))
...
double xmm7_7 = *(((ecx_1 * 5 + edx_2) << 4) + 0x763bc0)
double xmm2_6 = _mm_unpackhi_pd(xmm2_5, xmm2_5)
double xmm7_10 = (xmm7_7 + *(((ecx_1 * 5 + edx_2) << 4) + 0x763bc8)) * xmm2_6
    + *(((ecx_1 * 5 + edx_2) << 4) + 0x763bb8)
double xmm2_8 = _mm_and_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x763bd8), xmm6)
double xmm2_9 = xmm2_8 - *(((ecx_1 * 5 + edx_2) << 4) + 0x763bb0)
double xmm3_9 = xmm3_8 - xmm2_9
double xmm0_11 = xmm0_8 + xmm7_10 + xmm1_15 + xmm1_14.q f- xmm3_8 + xmm3_8 - (xmm2_9 + xmm3_9)
    - (1.0 - xmm5_2 * xmm2_8 - xmm2_5.q f* xmm6) * xmm6 f* *(((ecx_1 * 5 + edx_2) << 4) + 0x763bd0)
double var_c = xmm0_11 + xmm3_9
return 0x763b30 + ((ecx_1 * 5 + edx_2) << 4)
